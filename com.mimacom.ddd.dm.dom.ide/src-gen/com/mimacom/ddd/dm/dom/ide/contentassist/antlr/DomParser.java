...
public class DomParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DomGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDomSnapshotAccess().getGroup_2(), "rule__DomSnapshot__Group_2__0");
			...
			builder.put(grammarAccess.getDomModelAccess().getSnapshotsAssignment(), "rule__DomModel__SnapshotsAssignment");
			builder.put(grammarAccess.getDomSnapshotAccess().getNameAssignment_1(), "rule__DomSnapshot__NameAssignment_1");
			builder.put(grammarAccess.getDomSnapshotAccess().getAliasAssignment_2_1(), "rule__DomSnapshot__AliasAssignment_2_1");
			builder.put(grammarAccess.getDomSnapshotAccess().getDescriptionAssignment_3(), "rule__DomSnapshot__DescriptionAssignment_3");
			builder.put(grammarAccess.getDomSnapshotAccess().getNotesAssignment_4(), "rule__DomSnapshot__NotesAssignment_4");
			builder.put(grammarAccess.getDomSnapshotAccess().getObjectsAssignment_6(), "rule__DomSnapshot__ObjectsAssignment_6");
			...
			builder.put(grammarAccess.getDomNamedComplexObjectAccess().getDescriptionAssignment_3(), "rule__DomNamedComplexObject__DescriptionAssignment_3");
			builder.put(grammarAccess.getDomNamedComplexObjectAccess().getNotesAssignment_4(), "rule__DomNamedComplexObject__NotesAssignment_4");
