...
public class DomParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DomGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDNamespaceAccess().getImportsAssignment_0(), "rule__DNamespace__ImportsAssignment_0");
			builder.put(grammarAccess.getDNamespaceAccess().getNameAssignment_2(), "rule__DNamespace__NameAssignment_2");
			...
			builder.put(grammarAccess.getDomSnapshotAccess().getAliasesAssignment_2_1(), "rule__DomSnapshot__AliasesAssignment_2_1");
			builder.put(grammarAccess.getDomSnapshotAccess().getDescriptionAssignment_3(), "rule__DomSnapshot__DescriptionAssignment_3");
			builder.put(grammarAccess.getDomSnapshotAccess().getObjectsAssignment_5(), "rule__DomSnapshot__ObjectsAssignment_5");
