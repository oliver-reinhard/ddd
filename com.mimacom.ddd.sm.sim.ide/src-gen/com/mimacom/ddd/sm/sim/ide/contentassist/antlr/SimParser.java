...
public class SimParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SimGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSPrimitiveDeductionAccess().getDeductionRuleAssignment_3(), "rule__SPrimitiveDeduction__DeductionRuleAssignment_3");
			builder.put(grammarAccess.getSPrimitiveDeductionAccess().getDescriptionAssignment_4(), "rule__SPrimitiveDeduction__DescriptionAssignment_4");
			builder.put(grammarAccess.getSPrimitiveDeductionAccess().getConstraintsAssignment_6(), "rule__SPrimitiveDeduction__ConstraintsAssignment_6");
