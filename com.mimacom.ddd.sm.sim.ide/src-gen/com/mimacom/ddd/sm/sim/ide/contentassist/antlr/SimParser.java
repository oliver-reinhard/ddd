...
public class SimParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SimGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getSInformationModelAccess().getAlternatives_7(), "rule__SInformationModel__Alternatives_7");
			...
			builder.put(grammarAccess.getDAggregateAccess().getAlternatives_5(), "rule__DAggregate__Alternatives_5");
			...
			builder.put(grammarAccess.getSComplexTypeFeaturesAccess().getAlternatives(), "rule__SComplexTypeFeatures__Alternatives");
			builder.put(grammarAccess.getSComplexTypeFeaturesAccess().getAlternatives_0_2(), "rule__SComplexTypeFeatures__Alternatives_0_2");
			...
			builder.put(grammarAccess.getDAggregateAccess().getGroup_5_1(), "rule__DAggregate__Group_5_1__0");
			...
			builder.put(grammarAccess.getDEnumerationAccess().getGroup_4_1_1(), "rule__DEnumeration__Group_4_1_1__0");
			...
			builder.put(grammarAccess.getSComplexTypeFeaturesAccess().getGroup_0(), "rule__SComplexTypeFeatures__Group_0__0");
			builder.put(grammarAccess.getSComplexTypeFeaturesAccess().getGroup_1(), "rule__SComplexTypeFeatures__Group_1__0");
			...
			builder.put(grammarAccess.getSAggregateDeductionAccess().getFeaturesAssignment_5_1_1_1(), "rule__SAggregateDeduction__FeaturesAssignment_5_1_1_1");
			...
			builder.put(grammarAccess.getDAggregateAccess().getFeaturesAssignment_5_0(), "rule__DAggregate__FeaturesAssignment_5_0");
			builder.put(grammarAccess.getDAggregateAccess().getFeaturesAssignment_5_1_1(), "rule__DAggregate__FeaturesAssignment_5_1_1");
			...
			builder.put(grammarAccess.getSPrimitiveDeductionAccess().getConstraintsAssignment_3_1(), "rule__SPrimitiveDeduction__ConstraintsAssignment_3_1");
			...
			builder.put(grammarAccess.getSEnumerationDeductionAccess().getConstraintsAssignment_3_2(), "rule__SEnumerationDeduction__ConstraintsAssignment_3_2");
			...
			builder.put(grammarAccess.getDEnumerationAccess().getLiteralsAssignment_4_1_0(), "rule__DEnumeration__LiteralsAssignment_4_1_0");
			builder.put(grammarAccess.getDEnumerationAccess().getLiteralsAssignment_4_1_1_1(), "rule__DEnumeration__LiteralsAssignment_4_1_1_1");
			builder.put(grammarAccess.getDEnumerationAccess().getConstraintsAssignment_4_2(), "rule__DEnumeration__ConstraintsAssignment_4_2");
			...
			builder.put(grammarAccess.getSComplexTypeFeaturesAccess().getFeaturesAssignment_0_2_0(), "rule__SComplexTypeFeatures__FeaturesAssignment_0_2_0");
			builder.put(grammarAccess.getSComplexTypeFeaturesAccess().getConstraintsAssignment_0_2_1(), "rule__SComplexTypeFeatures__ConstraintsAssignment_0_2_1");
