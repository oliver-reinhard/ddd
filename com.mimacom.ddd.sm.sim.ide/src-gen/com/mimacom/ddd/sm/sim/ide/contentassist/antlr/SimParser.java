...
public class SimParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SimGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSRootTypeAccess().getGroup_0_4(), "rule__SRootType__Group_0_4__0");
			...
			builder.put(grammarAccess.getSRootTypeAccess().getAbstractAssignment_0_0_2(), "rule__SRootType__AbstractAssignment_0_0_2");
			builder.put(grammarAccess.getSRootTypeAccess().getDeductionRuleAssignment_0_0_4(), "rule__SRootType__DeductionRuleAssignment_0_0_4");
			builder.put(grammarAccess.getSRootTypeAccess().getAbstractAssignment_0_1_2(), "rule__SRootType__AbstractAssignment_0_1_2");
			builder.put(grammarAccess.getSRootTypeAccess().getDeductionRuleAssignment_0_1_4(), "rule__SRootType__DeductionRuleAssignment_0_1_4");
			builder.put(grammarAccess.getSRootTypeAccess().getAbstractAssignment_0_2_2(), "rule__SRootType__AbstractAssignment_0_2_2");
			builder.put(grammarAccess.getSRootTypeAccess().getDeductionRuleAssignment_0_2_4(), "rule__SRootType__DeductionRuleAssignment_0_2_4");
			builder.put(grammarAccess.getSRootTypeAccess().getAbstractAssignment_0_3_2(), "rule__SRootType__AbstractAssignment_0_3_2");
			builder.put(grammarAccess.getSRootTypeAccess().getDeductionRuleAssignment_0_3_4(), "rule__SRootType__DeductionRuleAssignment_0_3_4");
			builder.put(grammarAccess.getSRootTypeAccess().getAbstractAssignment_0_4_0(), "rule__SRootType__AbstractAssignment_0_4_0");
			builder.put(grammarAccess.getSRootTypeAccess().getNameAssignment_0_4_2(), "rule__SRootType__NameAssignment_0_4_2");
