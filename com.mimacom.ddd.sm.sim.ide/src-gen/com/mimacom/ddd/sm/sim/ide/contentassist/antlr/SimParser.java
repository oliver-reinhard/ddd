...
public class SimParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SimGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDContextReferenceAccess().getAlternatives_1_0_1(), "rule__DContextReference__Alternatives_1_0_1");
			...
			builder.put(grammarAccess.getDContextReferenceAccess().getBeforeAssignment_1_0_1_0(), "rule__DContextReference__BeforeAssignment_1_0_1_0");
			builder.put(grammarAccess.getDContextReferenceAccess().getAllAssignment_1_0_1_1(), "rule__DContextReference__AllAssignment_1_0_1_1");
