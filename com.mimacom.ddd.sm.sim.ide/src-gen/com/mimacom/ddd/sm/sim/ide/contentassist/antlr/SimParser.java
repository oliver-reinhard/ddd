...
public class SimParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SimGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDPrimitiveArchetypeAccess().getSystemTypeAssignment_3(), "rule__DPrimitiveArchetype__SystemTypeAssignment_3");
			builder.put(grammarAccess.getDPrimitiveArchetypeAccess().getDescriptionAssignment_4(), "rule__DPrimitiveArchetype__DescriptionAssignment_4");
