...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>SPrimitive Deduction</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class SPrimitiveDeductionImpl extends DPrimitiveImpl implements SPrimitiveDeduction
{
	 ...
	 * @generated
	 */
	protected SPrimitiveDeductionImpl()
	{
		super();
	}
	...
	{
		return SimPackage.Literals.SPRIMITIVE_DEDUCTION;
	}
	...
	public NotificationChain basicSetDeductionRule(DDeductionRule newDeductionRule, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimPackage.SPRIMITIVE_DEDUCTION__DEDUCTION_RULE, oldDeductionRule, newDeductionRule);
	...
	public void setDeductionRule(DDeductionRule newDeductionRule)
	{
		if (newDeductionRule != deductionRule)
		{
			...
			if (deductionRule != null)
				msgs = ((InternalEObject)deductionRule).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimPackage.SPRIMITIVE_DEDUCTION__DEDUCTION_RULE, null, msgs);
			if (newDeductionRule != null)
				msgs = ((InternalEObject)newDeductionRule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimPackage.SPRIMITIVE_DEDUCTION__DEDUCTION_RULE, null, msgs);
			msgs = basicSetDeductionRule(newDeductionRule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimPackage.SPRIMITIVE_DEDUCTION__DEDUCTION_RULE, newDeductionRule, newDeductionRule));
	}
