 ...
 *   <li>{@link com.mimacom.ddd.sm.sim.impl.SQueryDeductionImpl#getImpliedDeductions <em>Implied Deductions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SQueryDeductionImpl extends DQueryImplCustom implements SQueryDeduction
{
	...
	public EList<DImplicitDeduction> getImpliedDeductions()
	{
		...
		{
			impliedDeductions = new EObjectContainmentEList<DImplicitDeduction>(DImplicitDeduction.class, this, SimPackage.SQUERY_DEDUCTION__IMPLIED_DEDUCTIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			...
			case SimPackage.SQUERY_DEDUCTION__IMPLIED_DEDUCTIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == IDeductionDefinition.class)
		{
			switch (derivedFeatureID)
			{
				...
				case SimPackage.SQUERY_DEDUCTION__IMPLIED_DEDUCTIONS: return BasePackage.IDEDUCTION_DEFINITION__IMPLIED_DEDUCTIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == IDeductionDefinition.class)
		{
			switch (baseFeatureID)
			{
				...
				case BasePackage.IDEDUCTION_DEFINITION__IMPLIED_DEDUCTIONS: return SimPackage.SQUERY_DEDUCTION__IMPLIED_DEDUCTIONS;
				default: return -1;
			}
		}
		if (baseClass == SFeatureDeduction.class)
