...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>SDomain Proxy</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.sm.sim.impl.SDomainProxyImpl#getDeductionRule <em>Deduction Rule</em>}</li>
 *   <li>{@link com.mimacom.ddd.sm.sim.impl.SDomainProxyImpl#getNature <em>Nature</em>}</li>
 *   <li>{@link com.mimacom.ddd.sm.sim.impl.SDomainProxyImpl#isSynthetic <em>Synthetic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SDomainProxyImpl extends MinimalEObjectImpl.Container implements SDomainProxy
{
	/**
	...
	{
		return SimPackage.Literals.SDOMAIN_PROXY;
	}
	...
	public NotificationChain basicSetDeductionRule(SDeductionRule newDeductionRule, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimPackage.SDOMAIN_PROXY__DEDUCTION_RULE, oldDeductionRule, newDeductionRule);
	...
	public void setDeductionRule(SDeductionRule newDeductionRule)
	{
		if (newDeductionRule != deductionRule)
		{
			...
			if (deductionRule != null)
				msgs = ((InternalEObject)deductionRule).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimPackage.SDOMAIN_PROXY__DEDUCTION_RULE, null, msgs);
			if (newDeductionRule != null)
				msgs = ((InternalEObject)newDeductionRule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimPackage.SDOMAIN_PROXY__DEDUCTION_RULE, null, msgs);
			msgs = basicSetDeductionRule(newDeductionRule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimPackage.SDOMAIN_PROXY__DEDUCTION_RULE, newDeductionRule, newDeductionRule));
	}
	...
	public void setSynthetic(boolean newSynthetic)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimPackage.SDOMAIN_PROXY__SYNTHETIC, oldSynthetic, synthetic));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case SimPackage.SDOMAIN_PROXY__DEDUCTION_RULE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case SimPackage.SDOMAIN_PROXY__NATURE:
				return getNature();
			case SimPackage.SDOMAIN_PROXY__SYNTHETIC:
				return isSynthetic();
		}
