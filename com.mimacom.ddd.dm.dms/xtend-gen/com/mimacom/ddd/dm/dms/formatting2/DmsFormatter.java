...
public class DmsFormatter extends AbstractFormatter2 {
  ...
  protected void _format(final DDomain domain, @Extension final IFormattableDocument document) {
    ...
    document.append(this.textRegionExtensions.regionFor(domain).assignment(this._dmsGrammarAccess.getDDomainAccess().getNameAssignment_1()), _function);
  ...
  protected void _format(final DAggregate aggregate, @Extension final IFormattableDocument document) {
    final ISemanticRegion open = this.textRegionExtensions.regionFor(aggregate).keyword(this._dmsGrammarAccess.getDAggregateAccess().getLeftCurlyBracketKeyword_3());
    final ISemanticRegion close = this.textRegionExtensions.regionFor(aggregate).keyword(this._dmsGrammarAccess.getDAggregateAccess().getRightCurlyBracketKeyword_5());
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.setNewLines(2);
    };
  ...
  protected void _format(final DEnumeration en, @Extension final IFormattableDocument document) {
    ...
    if (_greaterThan) {
      final ISemanticRegion open = this.textRegionExtensions.regionFor(en).keyword(this._dmsGrammarAccess.getDEnumerationAccess().getLeftCurlyBracketKeyword_3());
      final ISemanticRegion close = this.textRegionExtensions.regionFor(en).keyword(this._dmsGrammarAccess.getDEnumerationAccess().getRightCurlyBracketKeyword_6());
      final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
        it.newLine();
      };
      document.append(open, _function);
      ...
      for (final DLiteral literal : _literals) {
        ...
        document.surround(this.textRegionExtensions.regionFor(literal).assignment(this._dmsGrammarAccess.getDLiteralAccess().getNameAssignment_0()), _function_2);
      }
      List<ISemanticRegion> _keywords = this.textRegionExtensions.regionFor(en).keywords(this._dmsGrammarAccess.getDEnumerationAccess().getCommaKeyword_4_1_0());
  ...
  protected void _format(final DComplexType type, @Extension final IFormattableDocument document) {
    final ISemanticRegion open = this.textRegionExtensions.regionFor(type).keyword(this._dmsGrammarAccess.getDComplexTypeAccess().getLeftCurlyBracketKeyword_3());
    final ISemanticRegion close = this.textRegionExtensions.regionFor(type).keyword(this._dmsGrammarAccess.getDComplexTypeAccess().getRightCurlyBracketKeyword_5());
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.newLine();
    };
    document.append(open, _function);
