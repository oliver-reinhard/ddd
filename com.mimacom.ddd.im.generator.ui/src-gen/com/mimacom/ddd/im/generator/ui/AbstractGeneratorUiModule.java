...
import com.mimacom.ddd.im.generator.ide.contentassist.antlr.GeneratorParser;
import com.mimacom.ddd.im.generator.ide.contentassist.antlr.PartialGeneratorContentAssistParser;
import com.mimacom.ddd.im.generator.ide.contentassist.antlr.internal.InternalGeneratorLexer;
import com.mimacom.ddd.im.generator.ui.contentassist.GeneratorProposalProvider;
import com.mimacom.ddd.im.generator.ui.editor.GeneratorEditor;
import com.mimacom.ddd.im.generator.ui.labeling.GeneratorDescriptionLabelProvider;
import com.mimacom.ddd.im.generator.ui.labeling.GeneratorLabelProvider;
import com.mimacom.ddd.im.generator.ui.outline.GeneratorOutlineTreeProvider;
import com.mimacom.ddd.im.generator.ui.quickfix.GeneratorQuickfixProvider;
import com.mimacom.ddd.im.generator.validation.GeneratorValidatorConfigurationBlock;
...
public abstract class AbstractGeneratorUiModule extends DefaultXbaseUiModule {

	public AbstractGeneratorUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalGeneratorLexer.class);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(com.mimacom.ddd.im.generator.parser.antlr.internal.InternalGeneratorLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return GeneratorParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalGeneratorLexer.class).toProvider(LexerProvider.create(InternalGeneratorLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return GeneratorValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return GeneratorLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(GeneratorDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return GeneratorOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return GeneratorQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return GeneratorProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialGeneratorContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Generator Compare");
	}
