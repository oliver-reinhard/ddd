...
public class PubProtoGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class PublicationClassElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cSegmentsProtoDocumentSegmentParserRuleCall_8_0 = (RuleCall)cSegmentsAssignment_8.eContents().get(0);
		private final Keyword cDivisionsKeyword_9 = (Keyword)cGroup.eContents().get(9);
		private final Assignment cDivisionsAssignment_10 = (Assignment)cGroup.eContents().get(10);
		private final RuleCall cDivisionsProtoDivisionParserRuleCall_10_0 = (RuleCall)cDivisionsAssignment_10.eContents().get(0);
		...
		//{PublicationClass} 'publication' 'class' name=ID ('title:' title=STRING)? 'nature:' nature=PublicationNature 'segments:'
		//segments+=ProtoDocumentSegment* 'divisions:' divisions+=ProtoDivision*
		...
		public RuleCall getSegmentsProtoDocumentSegmentParserRuleCall_8_0() { return cSegmentsProtoDocumentSegmentParserRuleCall_8_0; }
		
		//'divisions:'
		public Keyword getDivisionsKeyword_9() { return cDivisionsKeyword_9; }
		
		//divisions+=ProtoDivision*
		public Assignment getDivisionsAssignment_10() { return cDivisionsAssignment_10; }
		
		//ProtoDivision
		public RuleCall getDivisionsProtoDivisionParserRuleCall_10_0() { return cDivisionsProtoDivisionParserRuleCall_10_0; }
	}
