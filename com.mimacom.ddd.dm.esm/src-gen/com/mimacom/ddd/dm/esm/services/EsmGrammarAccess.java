...
public class EsmGrammarAccess extends AbstractGrammarElementFinder {
	...
	//DmxModel:
	//	{DmxModel} ('text' NATURAL ':' texts+=DRichText ';')* ('expr' NATURAL ':' expressions+=super::DExpression ';')*;
	...
	//	super::DPrimaryExpression (=> ({DAssignment.memberContainer=current} '.' member=[DNavigableMember] OpSingleAssign)
	//	value=DAssignment
