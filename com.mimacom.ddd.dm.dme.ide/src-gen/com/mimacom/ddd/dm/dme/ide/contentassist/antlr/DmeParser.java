 ...
 */
package com.mimacom.ddd.dm.dme.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import com.mimacom.ddd.dm.dme.ide.contentassist.antlr.internal.InternalDmeParser;
import com.mimacom.ddd.dm.dme.services.DmeGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class DmeParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(DmeGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DmeGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDDomainAccess().getEventsAssignment_4_0(), "rule__DDomain__EventsAssignment_4_0");
			builder.put(grammarAccess.getDDomainAccess().getActorsAssignment_4_1(), "rule__DDomain__ActorsAssignment_4_1");
			...
			builder.put(grammarAccess.getDDomainEventAccess().getDescriptionAssignment_2(), "rule__DDomainEvent__DescriptionAssignment_2");
			builder.put(grammarAccess.getDDomainEventAccess().getContextAssignment_5(), "rule__DDomainEvent__ContextAssignment_5");
			builder.put(grammarAccess.getDDomainEventAccess().getTriggerAssignment_8(), "rule__DDomainEvent__TriggerAssignment_8");
			builder.put(grammarAccess.getDDomainEventAccess().getNotificationsAssignment_9_1(), "rule__DDomainEvent__NotificationsAssignment_9_1");
			builder.put(grammarAccess.getDDomainEventAccess().getBeforeAssignment_10_2(), "rule__DDomainEvent__BeforeAssignment_10_2");
			builder.put(grammarAccess.getDDomainEventAccess().getAfterAssignment_11_2(), "rule__DDomainEvent__AfterAssignment_11_2");
			builder.put(grammarAccess.getDConditionAccess().getNameAssignment_0(), "rule__DCondition__NameAssignment_0");
			builder.put(grammarAccess.getDConditionAccess().getConditionAssignment_2(), "rule__DCondition__ConditionAssignment_2");
			builder.put(grammarAccess.getDConditionAccess().getDescriptionAssignment_3(), "rule__DCondition__DescriptionAssignment_3");
			builder.put(grammarAccess.getDNotificationAccess().getNameAssignment_0(), "rule__DNotification__NameAssignment_0");
			builder.put(grammarAccess.getDNotificationAccess().getTypeAssignment_2(), "rule__DNotification__TypeAssignment_2");
			builder.put(grammarAccess.getDNotificationAccess().getMultiplicityAssignment_3(), "rule__DNotification__MultiplicityAssignment_3");
			...
			builder.put(grammarAccess.getDContextAccess().getTypeAssignment_2(), "rule__DContext__TypeAssignment_2");
			builder.put(grammarAccess.getDContextAccess().getMultiplicityAssignment_3(), "rule__DContext__MultiplicityAssignment_3");
			builder.put(grammarAccess.getDContextAccess().getDescriptionAssignment_4(), "rule__DContext__DescriptionAssignment_4");
	...
	@Override
	protected InternalDmeParser createParser() {
		InternalDmeParser result = new InternalDmeParser(null);
