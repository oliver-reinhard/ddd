...
public class DivTypeDiagramRendererSVGExtensionFactory implements IExecutableExtensionFactory {

	@Override
	public Object create() throws CoreException {
		final DivTypeDiagramRenderer obj = new DivTypeDiagramRenderer(PlantUmlFileFormat.SVG);
