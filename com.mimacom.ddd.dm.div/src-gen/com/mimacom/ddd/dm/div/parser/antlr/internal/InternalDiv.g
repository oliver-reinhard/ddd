...
@after {
	...
	(
		...
		otherlv_7='{'
		{
			newLeafNode(otherlv_7, grammarAccess.getDomainInformationViewAccess().getLeftCurlyBracketKeyword_7());
		}
		(
			(
				(
		...
		otherlv_10='}'
		{
			newLeafNode(otherlv_10, grammarAccess.getDomainInformationViewAccess().getRightCurlyBracketKeyword_9());
		}
	)
;
