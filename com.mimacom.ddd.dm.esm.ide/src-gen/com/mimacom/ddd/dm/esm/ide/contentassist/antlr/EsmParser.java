...
public class EsmParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EsmGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEsmStateAccess().getGroup(), "rule__EsmState__Group__0");
			builder.put(grammarAccess.getEsmStateAccess().getGroup_1(), "rule__EsmState__Group_1__0");
			builder.put(grammarAccess.getEsmTransitionAccess().getGroup(), "rule__EsmTransition__Group__0");
			builder.put(grammarAccess.getEsmTransitionAccess().getGroup_5(), "rule__EsmTransition__Group_5__0");
			...
			builder.put(grammarAccess.getEsmEntityStateModelAccess().getStatesAssignment_7(), "rule__EsmEntityStateModel__StatesAssignment_7");
			builder.put(grammarAccess.getEsmEntityStateModelAccess().getTransitionAssignment_9(), "rule__EsmEntityStateModel__TransitionAssignment_9");
			builder.put(grammarAccess.getEsmStateAccess().getStateAssignment_0(), "rule__EsmState__StateAssignment_0");
			builder.put(grammarAccess.getEsmStateAccess().getExpressionAssignment_1_1(), "rule__EsmState__ExpressionAssignment_1_1");
			builder.put(grammarAccess.getEsmTransitionAccess().getFromAssignment_0(), "rule__EsmTransition__FromAssignment_0");
			builder.put(grammarAccess.getEsmTransitionAccess().getToAssignment_2(), "rule__EsmTransition__ToAssignment_2");
			builder.put(grammarAccess.getEsmTransitionAccess().getEventAssignment_4(), "rule__EsmTransition__EventAssignment_4");
			builder.put(grammarAccess.getEsmTransitionAccess().getGuardAssignment_5_1(), "rule__EsmTransition__GuardAssignment_5_1");
