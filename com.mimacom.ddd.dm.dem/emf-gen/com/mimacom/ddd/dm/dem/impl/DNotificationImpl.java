 ...
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.dm.dem.impl.DNotificationImpl#getNavigableMembers <em>Navigable Members</em>}</li>
 *   <li>{@link com.mimacom.ddd.dm.dem.impl.DNotificationImpl#getMessage <em>Message</em>}</li>
 *   <li>{@link com.mimacom.ddd.dm.dem.impl.DNotificationImpl#getNotified <em>Notified</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DNotificationImpl extends DNavigableMemberImplCustom implements DNotification
{
	...
	{
		return DemPackage.Literals.DNOTIFICATION;
	}
	...
	public NotificationChain basicSetMessage(DMessage newMessage, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DemPackage.DNOTIFICATION__MESSAGE, oldMessage, newMessage);
	...
	public void setMessage(DMessage newMessage)
	{
		if (newMessage != message)
		{
			...
			if (message != null)
				msgs = ((InternalEObject)message).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DemPackage.DNOTIFICATION__MESSAGE, null, msgs);
			if (newMessage != null)
				msgs = ((InternalEObject)newMessage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DemPackage.DNOTIFICATION__MESSAGE, null, msgs);
			msgs = basicSetMessage(newMessage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DemPackage.DNOTIFICATION__MESSAGE, newMessage, newMessage));
	}
	...
	public DActor getNotified()
	{
		if (notified != null && notified.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DemPackage.DNOTIFICATION__NOTIFIED, oldNotified, notified));
			}
		}
		return notified;
	}
	...
	public void setNotified(DActor newNotified)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DemPackage.DNOTIFICATION__NOTIFIED, oldNotified, notified));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case DemPackage.DNOTIFICATION__MESSAGE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case DemPackage.DNOTIFICATION__NAVIGABLE_MEMBERS:
				return getNavigableMembers();
			case DemPackage.DNOTIFICATION__MESSAGE:
				return getMessage();
			case DemPackage.DNOTIFICATION__NOTIFIED:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == INavigableMemberContainer.class)
		{
			...
			{
				case DemPackage.DNOTIFICATION__NAVIGABLE_MEMBERS: return BasePackage.INAVIGABLE_MEMBER_CONTAINER__NAVIGABLE_MEMBERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == INavigableMemberContainer.class)
		{
			...
			{
				case BasePackage.INAVIGABLE_MEMBER_CONTAINER__NAVIGABLE_MEMBERS: return DemPackage.DNOTIFICATION__NAVIGABLE_MEMBERS;
				default: return -1;
			}
		}
