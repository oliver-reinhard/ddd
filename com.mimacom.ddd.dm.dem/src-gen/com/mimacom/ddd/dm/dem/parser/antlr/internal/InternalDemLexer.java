...
public class InternalDemLexer extends Lexer {
    ...
    public final void mRULE_PLAIN_TEXT_START() throws RecognitionException {
        try {
            ...
            {
            match('\u00AB'); 
            // InternalDem.g:5535:34: ( RULE_PLAIN_TEXT )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_PLAIN_TEXT_MIDDLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDem.g:5537:24: ( ']' ( RULE_PLAIN_TEXT )* '[' )
            // InternalDem.g:5537:26: ']' ( RULE_PLAIN_TEXT )* '['
            {
            match(']'); 
            // InternalDem.g:5537:30: ( RULE_PLAIN_TEXT )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_PLAIN_TEXT_END() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDem.g:5539:21: ( ']' ( RULE_PLAIN_TEXT )* '\\u00BB' )
            // InternalDem.g:5539:23: ']' ( RULE_PLAIN_TEXT )* '\\u00BB'
            {
            match(']'); 
            // InternalDem.g:5539:27: ( RULE_PLAIN_TEXT )*
            loop9:
            do {
                int alt9=2;
