...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DFor Loop Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.dm.dmx.impl.DForLoopExpressionImpl#getDeclaredParam <em>Declared Param</em>}</li>
 *   <li>{@link com.mimacom.ddd.dm.dmx.impl.DForLoopExpressionImpl#getForExpression <em>For Expression</em>}</li>
 *   <li>{@link com.mimacom.ddd.dm.dmx.impl.DForLoopExpressionImpl#getEachExpression <em>Each Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DForLoopExpressionImpl extends DExpressionImpl implements DForLoopExpression
{
	/**
	 ...
	 * @generated
	 */
	protected DForLoopExpressionImpl()
	{
		super();
	}
	...
	{
		return DmxPackage.Literals.DFOR_LOOP_EXPRESSION;
	}
	...
	public void setDeclaredParam(String newDeclaredParam)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmxPackage.DFOR_LOOP_EXPRESSION__DECLARED_PARAM, oldDeclaredParam, declaredParam));
	}
	...
	public NotificationChain basicSetForExpression(DExpression newForExpression, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DmxPackage.DFOR_LOOP_EXPRESSION__FOR_EXPRESSION, oldForExpression, newForExpression);
	...
	public void setForExpression(DExpression newForExpression)
	{
		if (newForExpression != forExpression)
		{
			...
			if (forExpression != null)
				msgs = ((InternalEObject)forExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DmxPackage.DFOR_LOOP_EXPRESSION__FOR_EXPRESSION, null, msgs);
			if (newForExpression != null)
				msgs = ((InternalEObject)newForExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DmxPackage.DFOR_LOOP_EXPRESSION__FOR_EXPRESSION, null, msgs);
			msgs = basicSetForExpression(newForExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmxPackage.DFOR_LOOP_EXPRESSION__FOR_EXPRESSION, newForExpression, newForExpression));
	}
	...
	public NotificationChain basicSetEachExpression(DExpression newEachExpression, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DmxPackage.DFOR_LOOP_EXPRESSION__EACH_EXPRESSION, oldEachExpression, newEachExpression);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEachExpression(DExpression newEachExpression)
	{
		if (newEachExpression != eachExpression)
		{
			...
			if (eachExpression != null)
				msgs = ((InternalEObject)eachExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DmxPackage.DFOR_LOOP_EXPRESSION__EACH_EXPRESSION, null, msgs);
			if (newEachExpression != null)
				msgs = ((InternalEObject)newEachExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DmxPackage.DFOR_LOOP_EXPRESSION__EACH_EXPRESSION, null, msgs);
			msgs = basicSetEachExpression(newEachExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmxPackage.DFOR_LOOP_EXPRESSION__EACH_EXPRESSION, newEachExpression, newEachExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case DmxPackage.DFOR_LOOP_EXPRESSION__FOR_EXPRESSION:
				return basicSetForExpression(null, msgs);
			case DmxPackage.DFOR_LOOP_EXPRESSION__EACH_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case DmxPackage.DFOR_LOOP_EXPRESSION__DECLARED_PARAM:
