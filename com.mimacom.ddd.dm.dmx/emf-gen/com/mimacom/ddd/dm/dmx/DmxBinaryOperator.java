 ...
 * <!-- end-user-doc -->
 * @see com.mimacom.ddd.dm.dmx.DmxPackage#getDmxBinaryOperator()
 * @model
 * @generated
 */
public enum DmxBinaryOperator implements Enumerator
{
	/**
	 ...
	 * @generated
	 */
	private static final DmxBinaryOperator[] VALUES_ARRAY =
		new DmxBinaryOperator[]
		{
			ADD,
			SUBTRACT,
			MULTIPLY,
	 ...
	 * @generated
	 */
	public static final List<DmxBinaryOperator> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static DmxBinaryOperator get(String literal)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			DmxBinaryOperator result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static DmxBinaryOperator getByName(String name)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			DmxBinaryOperator result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static DmxBinaryOperator get(int value)
	{
		switch (value)
		{
	 ...
	 * @generated
	 */
	private DmxBinaryOperator(int value, String name, String literal)
	{
		this.value = value;
		this.name = name;
