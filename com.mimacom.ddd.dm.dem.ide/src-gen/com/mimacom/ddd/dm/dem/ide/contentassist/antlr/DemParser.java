...
public class DemParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DemGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDemDomainEventAccess().getAlternatives_12_1(), "rule__DemDomainEvent__Alternatives_12_1");
			builder.put(grammarAccess.getDemCaseConjunctionAccess().getAlternatives_4(), "rule__DemCaseConjunction__Alternatives_4");
			builder.put(grammarAccess.getDemActorAccess().getAlternatives(), "rule__DemActor__Alternatives");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getAlternatives_6(), "rule__DemEventsOverviewModel__Alternatives_6");
			...
			builder.put(grammarAccess.getDemDomainEventAccess().getGroup(), "rule__DemDomainEvent__Group__0");
			builder.put(grammarAccess.getDemDomainEventAccess().getGroup_3(), "rule__DemDomainEvent__Group_3__0");
			builder.put(grammarAccess.getDemDomainEventAccess().getGroup_9(), "rule__DemDomainEvent__Group_9__0");
			builder.put(grammarAccess.getDemDomainEventAccess().getGroup_10(), "rule__DemDomainEvent__Group_10__0");
			builder.put(grammarAccess.getDemDomainEventAccess().getGroup_11(), "rule__DemDomainEvent__Group_11__0");
			builder.put(grammarAccess.getDemDomainEventAccess().getGroup_12(), "rule__DemDomainEvent__Group_12__0");
			builder.put(grammarAccess.getDemTriggerAccess().getGroup(), "rule__DemTrigger__Group__0");
			...
			builder.put(grammarAccess.getDemCaseConjunctionAccess().getGroup(), "rule__DemCaseConjunction__Group__0");
			builder.put(grammarAccess.getDemCaseConjunctionAccess().getGroup_2(), "rule__DemCaseConjunction__Group_2__0");
			builder.put(grammarAccess.getDemCaseConjunctionAccess().getGroup_4_0(), "rule__DemCaseConjunction__Group_4_0__0");
			builder.put(grammarAccess.getDemNotificationAccess().getGroup(), "rule__DemNotification__Group__0");
			builder.put(grammarAccess.getDemNotificationAccess().getGroup_1(), "rule__DemNotification__Group_1__0");
			builder.put(grammarAccess.getDemMessageAccess().getGroup(), "rule__DemMessage__Group__0");
			...
			builder.put(grammarAccess.getDemHumanActorRoleAccess().getGroup(), "rule__DemHumanActorRole__Group__0");
			builder.put(grammarAccess.getDemHumanActorRoleAccess().getGroup_4(), "rule__DemHumanActorRole__Group_4__0");
			builder.put(grammarAccess.getDemServiceAccess().getGroup(), "rule__DemService__Group__0");
			builder.put(grammarAccess.getDemServiceAccess().getGroup_3(), "rule__DemService__Group_3__0");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getGroup(), "rule__DemEventsOverviewModel__Group__0");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getGroup_6_0(), "rule__DemEventsOverviewModel__Group_6_0__0");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getGroup_6_1(), "rule__DemEventsOverviewModel__Group_6_1__0");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getGroup_6_2(), "rule__DemEventsOverviewModel__Group_6_2__0");
			...
			builder.put(grammarAccess.getDemDomainEventAccess().getNameAssignment_2(), "rule__DemDomainEvent__NameAssignment_2");
			builder.put(grammarAccess.getDemDomainEventAccess().getAliasAssignment_3_1(), "rule__DemDomainEvent__AliasAssignment_3_1");
			builder.put(grammarAccess.getDemDomainEventAccess().getDescriptionAssignment_4(), "rule__DemDomainEvent__DescriptionAssignment_4");
			builder.put(grammarAccess.getDemDomainEventAccess().getNotesAssignment_5(), "rule__DemDomainEvent__NotesAssignment_5");
			builder.put(grammarAccess.getDemDomainEventAccess().getContextAssignment_8(), "rule__DemDomainEvent__ContextAssignment_8");
			builder.put(grammarAccess.getDemDomainEventAccess().getTriggersAssignment_9_2(), "rule__DemDomainEvent__TriggersAssignment_9_2");
			builder.put(grammarAccess.getDemDomainEventAccess().getNotificationsAssignment_10_1(), "rule__DemDomainEvent__NotificationsAssignment_10_1");
			builder.put(grammarAccess.getDemDomainEventAccess().getPreconditionsCNFAssignment_11_1(), "rule__DemDomainEvent__PreconditionsCNFAssignment_11_1");
			builder.put(grammarAccess.getDemDomainEventAccess().getPostconditionsDNFAssignment_12_1_0(), "rule__DemDomainEvent__PostconditionsDNFAssignment_12_1_0");
			builder.put(grammarAccess.getDemDomainEventAccess().getPostconditionsDNFAssignment_12_1_1(), "rule__DemDomainEvent__PostconditionsDNFAssignment_12_1_1");
			builder.put(grammarAccess.getDemTriggerAccess().getActorAssignment_0(), "rule__DemTrigger__ActorAssignment_0");
			builder.put(grammarAccess.getDemTriggerAccess().getNotesAssignment_1(), "rule__DemTrigger__NotesAssignment_1");
			builder.put(grammarAccess.getDNamedPredicateAccess().getNameAssignment_0(), "rule__DNamedPredicate__NameAssignment_0");
			builder.put(grammarAccess.getDNamedPredicateAccess().getAliasAssignment_1_1(), "rule__DNamedPredicate__AliasAssignment_1_1");
			builder.put(grammarAccess.getDNamedPredicateAccess().getDescriptionAssignment_3(), "rule__DNamedPredicate__DescriptionAssignment_3");
			builder.put(grammarAccess.getDNamedPredicateAccess().getNotesAssignment_4(), "rule__DNamedPredicate__NotesAssignment_4");
			builder.put(grammarAccess.getDNamedPredicateAccess().getPredicateAssignment_5(), "rule__DNamedPredicate__PredicateAssignment_5");
			builder.put(grammarAccess.getDemCaseConjunctionAccess().getNameAssignment_1(), "rule__DemCaseConjunction__NameAssignment_1");
			builder.put(grammarAccess.getDemCaseConjunctionAccess().getAliasAssignment_2_1(), "rule__DemCaseConjunction__AliasAssignment_2_1");
			builder.put(grammarAccess.getDemCaseConjunctionAccess().getDescriptionAssignment_3(), "rule__DemCaseConjunction__DescriptionAssignment_3");
			builder.put(grammarAccess.getDemCaseConjunctionAccess().getSelectorAssignment_4_0_1(), "rule__DemCaseConjunction__SelectorAssignment_4_0_1");
			builder.put(grammarAccess.getDemCaseConjunctionAccess().getOtherwiseAssignment_4_1(), "rule__DemCaseConjunction__OtherwiseAssignment_4_1");
			builder.put(grammarAccess.getDemCaseConjunctionAccess().getPredicatesAssignment_6(), "rule__DemCaseConjunction__PredicatesAssignment_6");
			builder.put(grammarAccess.getDemNotificationAccess().getNameAssignment_0(), "rule__DemNotification__NameAssignment_0");
			builder.put(grammarAccess.getDemNotificationAccess().getAliasAssignment_1_1(), "rule__DemNotification__AliasAssignment_1_1");
			builder.put(grammarAccess.getDemNotificationAccess().getMessageAssignment_3(), "rule__DemNotification__MessageAssignment_3");
			builder.put(grammarAccess.getDemNotificationAccess().getNotifiedAssignment_5(), "rule__DemNotification__NotifiedAssignment_5");
			builder.put(grammarAccess.getDemNotificationAccess().getDescriptionAssignment_6(), "rule__DemNotification__DescriptionAssignment_6");
			builder.put(grammarAccess.getDemNotificationAccess().getNotesAssignment_7(), "rule__DemNotification__NotesAssignment_7");
			builder.put(grammarAccess.getDemMessageAccess().getTypeAssignment_0(), "rule__DemMessage__TypeAssignment_0");
			builder.put(grammarAccess.getDemMessageAccess().getMultiplicityAssignment_1(), "rule__DemMessage__MultiplicityAssignment_1");
			builder.put(grammarAccess.getDContextAccess().getNameAssignment_0(), "rule__DContext__NameAssignment_0");
			builder.put(grammarAccess.getDContextAccess().getAliasAssignment_1_1(), "rule__DContext__AliasAssignment_1_1");
			...
			builder.put(grammarAccess.getDContextAccess().getNotesAssignment_6(), "rule__DContext__NotesAssignment_6");
			builder.put(grammarAccess.getDemActorModelAccess().getNameAssignment_2(), "rule__DemActorModel__NameAssignment_2");
			builder.put(grammarAccess.getDemActorModelAccess().getDescriptionAssignment_3(), "rule__DemActorModel__DescriptionAssignment_3");
			builder.put(grammarAccess.getDemActorModelAccess().getNotesAssignment_4(), "rule__DemActorModel__NotesAssignment_4");
			builder.put(grammarAccess.getDemActorModelAccess().getActorsAssignment_6(), "rule__DemActorModel__ActorsAssignment_6");
			builder.put(grammarAccess.getDemHumanActorRoleAccess().getNameAssignment_3(), "rule__DemHumanActorRole__NameAssignment_3");
			builder.put(grammarAccess.getDemHumanActorRoleAccess().getAliasAssignment_4_1(), "rule__DemHumanActorRole__AliasAssignment_4_1");
			builder.put(grammarAccess.getDemHumanActorRoleAccess().getDescriptionAssignment_5(), "rule__DemHumanActorRole__DescriptionAssignment_5");
			builder.put(grammarAccess.getDemHumanActorRoleAccess().getNotesAssignment_6(), "rule__DemHumanActorRole__NotesAssignment_6");
			builder.put(grammarAccess.getDemServiceAccess().getNameAssignment_2(), "rule__DemService__NameAssignment_2");
			builder.put(grammarAccess.getDemServiceAccess().getAliasAssignment_3_1(), "rule__DemService__AliasAssignment_3_1");
			builder.put(grammarAccess.getDemServiceAccess().getDescriptionAssignment_4(), "rule__DemService__DescriptionAssignment_4");
			builder.put(grammarAccess.getDemServiceAccess().getNotesAssignment_5(), "rule__DemService__NotesAssignment_5");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getNameAssignment_2(), "rule__DemEventsOverviewModel__NameAssignment_2");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getDescriptionAssignment_3(), "rule__DemEventsOverviewModel__DescriptionAssignment_3");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getNotesAssignment_4(), "rule__DemEventsOverviewModel__NotesAssignment_4");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getAllAssignment_6_0_1(), "rule__DemEventsOverviewModel__AllAssignment_6_0_1");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getIncludeAssignment_6_1_1(), "rule__DemEventsOverviewModel__IncludeAssignment_6_1_1");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getExcludeAssignment_6_2_1(), "rule__DemEventsOverviewModel__ExcludeAssignment_6_2_1");
