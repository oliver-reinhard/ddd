...
public class DemParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DemGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDemDomainEventAccess().getAliasesAssignment_3_1(), "rule__DemDomainEvent__AliasesAssignment_3_1");
			...
			builder.put(grammarAccess.getDemCaseConjunctionAccess().getAliasesAssignment_2_1(), "rule__DemCaseConjunction__AliasesAssignment_2_1");
			...
			builder.put(grammarAccess.getDemNotificationAccess().getAliasesAssignment_1_1(), "rule__DemNotification__AliasesAssignment_1_1");
			...
			builder.put(grammarAccess.getDemHumanActorRoleAccess().getAliasesAssignment_4_1(), "rule__DemHumanActorRole__AliasesAssignment_4_1");
			...
			builder.put(grammarAccess.getDemServiceAccess().getAliasesAssignment_3_1(), "rule__DemService__AliasesAssignment_3_1");
