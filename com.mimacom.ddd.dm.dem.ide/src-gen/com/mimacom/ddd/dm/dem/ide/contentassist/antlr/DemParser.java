...
public class DemParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DemGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDemDomainEventAccess().getAlternatives_10_1(), "rule__DemDomainEvent__Alternatives_10_1");
			...
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getAlternatives_4(), "rule__DemEventsOverviewModel__Alternatives_4");
			...
			builder.put(grammarAccess.getDemDomainEventAccess().getGroup_2(), "rule__DemDomainEvent__Group_2__0");
			builder.put(grammarAccess.getDemDomainEventAccess().getGroup_7(), "rule__DemDomainEvent__Group_7__0");
			builder.put(grammarAccess.getDemDomainEventAccess().getGroup_8(), "rule__DemDomainEvent__Group_8__0");
			...
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getGroup_4_0(), "rule__DemEventsOverviewModel__Group_4_0__0");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getGroup_4_1(), "rule__DemEventsOverviewModel__Group_4_1__0");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getGroup_4_2(), "rule__DemEventsOverviewModel__Group_4_2__0");
			...
			builder.put(grammarAccess.getDemDomainEventAccess().getNameAssignment_1(), "rule__DemDomainEvent__NameAssignment_1");
			builder.put(grammarAccess.getDemDomainEventAccess().getAliasesAssignment_2_1(), "rule__DemDomainEvent__AliasesAssignment_2_1");
			builder.put(grammarAccess.getDemDomainEventAccess().getDescriptionAssignment_3(), "rule__DemDomainEvent__DescriptionAssignment_3");
			builder.put(grammarAccess.getDemDomainEventAccess().getContextAssignment_6(), "rule__DemDomainEvent__ContextAssignment_6");
			builder.put(grammarAccess.getDemDomainEventAccess().getTriggersAssignment_7_2(), "rule__DemDomainEvent__TriggersAssignment_7_2");
			builder.put(grammarAccess.getDemDomainEventAccess().getNotificationsAssignment_8_1(), "rule__DemDomainEvent__NotificationsAssignment_8_1");
			builder.put(grammarAccess.getDemDomainEventAccess().getPreconditionsCNFAssignment_9_1(), "rule__DemDomainEvent__PreconditionsCNFAssignment_9_1");
			builder.put(grammarAccess.getDemDomainEventAccess().getPostconditionsDNFAssignment_10_1_0(), "rule__DemDomainEvent__PostconditionsDNFAssignment_10_1_0");
			builder.put(grammarAccess.getDemDomainEventAccess().getPostconditionsDNFAssignment_10_1_1(), "rule__DemDomainEvent__PostconditionsDNFAssignment_10_1_1");
			...
			builder.put(grammarAccess.getDNamedPredicateAccess().getPredicateAssignment_4(), "rule__DNamedPredicate__PredicateAssignment_4");
			...
			builder.put(grammarAccess.getDemActorModelAccess().getActorsAssignment_4(), "rule__DemActorModel__ActorsAssignment_4");
			...
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getAllAssignment_4_0_1(), "rule__DemEventsOverviewModel__AllAssignment_4_0_1");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getIncludeAssignment_4_1_1(), "rule__DemEventsOverviewModel__IncludeAssignment_4_1_1");
			builder.put(grammarAccess.getDemEventsOverviewModelAccess().getExcludeAssignment_4_2_1(), "rule__DemEventsOverviewModel__ExcludeAssignment_4_2_1");
