...
public class PubParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PubGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getProvidedTableAccess().getRendererAssignment_4(), "rule__ProvidedTable__RendererAssignment_4");
			...
			builder.put(grammarAccess.getProvidedFigureAccess().getRendererAssignment_4(), "rule__ProvidedFigure__RendererAssignment_4");
