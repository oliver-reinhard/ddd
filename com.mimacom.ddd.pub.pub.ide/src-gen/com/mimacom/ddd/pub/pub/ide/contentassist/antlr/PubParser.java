...
public class PubParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PubGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPubTableRowAccess().getGroup_1_0_1(), "rule__PubTableRow__Group_1_0_1__0");
			builder.put(grammarAccess.getPubTableRowAccess().getGroup_1_0_2_0(), "rule__PubTableRow__Group_1_0_2_0__0");
			...
			builder.put(grammarAccess.getPubTableRowAccess().getHeightAssignment_1_0_1_1(), "rule__PubTableRow__HeightAssignment_1_0_1_1");
			builder.put(grammarAccess.getPubTableRowAccess().getCellsAssignment_1_0_2_0_1(), "rule__PubTableRow__CellsAssignment_1_0_2_0_1");
			builder.put(grammarAccess.getPubTableRowAccess().getCellsAssignment_1_0_2_1(), "rule__PubTableRow__CellsAssignment_1_0_2_1");
