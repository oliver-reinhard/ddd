...
public class DimParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DimGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDEntityTypeAccess().getAlternatives_5(), "rule__DEntityType__Alternatives_5");
			...
			builder.put(grammarAccess.getDEntityTypeAccess().getGroup_4(), "rule__DEntityType__Group_4__0");
			builder.put(grammarAccess.getDEntityTypeAccess().getGroup_4_3(), "rule__DEntityType__Group_4_3__0");
			builder.put(grammarAccess.getDEntityTypeAccess().getGroup_4_5(), "rule__DEntityType__Group_4_5__0");
			builder.put(grammarAccess.getDEntityTypeAccess().getGroup_4_5_3(), "rule__DEntityType__Group_4_5_3__0");
			...
			builder.put(grammarAccess.getDEntityTypeAccess().getStatesAssignment_4_2(), "rule__DEntityType__StatesAssignment_4_2");
			builder.put(grammarAccess.getDEntityTypeAccess().getStatesAssignment_4_3_1(), "rule__DEntityType__StatesAssignment_4_3_1");
			builder.put(grammarAccess.getDEntityTypeAccess().getEventsAssignment_4_5_2(), "rule__DEntityType__EventsAssignment_4_5_2");
			builder.put(grammarAccess.getDEntityTypeAccess().getEventsAssignment_4_5_3_1(), "rule__DEntityType__EventsAssignment_4_5_3_1");
			builder.put(grammarAccess.getDEntityTypeAccess().getFeaturesAssignment_5_0(), "rule__DEntityType__FeaturesAssignment_5_0");
			builder.put(grammarAccess.getDEntityTypeAccess().getConstraintsAssignment_5_1(), "rule__DEntityType__ConstraintsAssignment_5_1");
