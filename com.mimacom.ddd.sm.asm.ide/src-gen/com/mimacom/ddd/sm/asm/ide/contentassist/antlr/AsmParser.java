...
public class AsmParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AsmGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAsmActorAccess().getAlternatives(), "rule__AsmActor__Alternatives");
			...
			builder.put(grammarAccess.getAsmServiceKindAccess().getAlternatives(), "rule__AsmServiceKind__Alternatives");
			builder.put(grammarAccess.getAsmParameterDirectionAccess().getAlternatives(), "rule__AsmParameterDirection__Alternatives");
			...
			builder.put(grammarAccess.getAsmApplicationAccess().getGroup(), "rule__AsmApplication__Group__0");
			builder.put(grammarAccess.getAsmApplicationAccess().getGroup_2(), "rule__AsmApplication__Group_2__0");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getGroup(), "rule__AsmServiceInterface__Group__0");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getGroup_3(), "rule__AsmServiceInterface__Group_3__0");
			builder.put(grammarAccess.getAsmWatchdogAccess().getGroup(), "rule__AsmWatchdog__Group__0");
			builder.put(grammarAccess.getAsmHumanAccess().getGroup(), "rule__AsmHuman__Group__0");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getGroup(), "rule__AsmServiceOperation__Group__0");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getGroup_3(), "rule__AsmServiceOperation__Group_3__0");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getGroup_3_1(), "rule__AsmServiceOperation__Group_3_1__0");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getGroup_5(), "rule__AsmServiceOperation__Group_5__0");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getGroup_5_2(), "rule__AsmServiceOperation__Group_5_2__0");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getGroup_7(), "rule__AsmServiceOperation__Group_7__0");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getGroup_8(), "rule__AsmServiceOperation__Group_8__0");
			builder.put(grammarAccess.getAsmServiceParameterAccess().getGroup(), "rule__AsmServiceParameter__Group__0");
			builder.put(grammarAccess.getAsmExceptionAccess().getGroup(), "rule__AsmException__Group__0");
			...
			builder.put(grammarAccess.getAsmApplicationAccess().getNameAssignment_1(), "rule__AsmApplication__NameAssignment_1");
			builder.put(grammarAccess.getAsmApplicationAccess().getAliasAssignment_2_1(), "rule__AsmApplication__AliasAssignment_2_1");
			builder.put(grammarAccess.getAsmApplicationAccess().getModelAssignment_5(), "rule__AsmApplication__ModelAssignment_5");
			builder.put(grammarAccess.getAsmApplicationAccess().getActorsAssignment_6(), "rule__AsmApplication__ActorsAssignment_6");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getNameAssignment_2(), "rule__AsmServiceInterface__NameAssignment_2");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getAliasAssignment_3_1(), "rule__AsmServiceInterface__AliasAssignment_3_1");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getInterfaceAssignment_6(), "rule__AsmServiceInterface__InterfaceAssignment_6");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getCoreAssignment_9(), "rule__AsmServiceInterface__CoreAssignment_9");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getExceptionsAssignment_10(), "rule__AsmServiceInterface__ExceptionsAssignment_10");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getOperationsAssignment_11(), "rule__AsmServiceInterface__OperationsAssignment_11");
			builder.put(grammarAccess.getAsmWatchdogAccess().getNameAssignment_1(), "rule__AsmWatchdog__NameAssignment_1");
			builder.put(grammarAccess.getAsmHumanAccess().getNameAssignment_1(), "rule__AsmHuman__NameAssignment_1");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getNameAssignment_1(), "rule__AsmServiceOperation__NameAssignment_1");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getParametersAssignment_3_0(), "rule__AsmServiceOperation__ParametersAssignment_3_0");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getParametersAssignment_3_1_1(), "rule__AsmServiceOperation__ParametersAssignment_3_1_1");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getRaisesAssignment_5_1(), "rule__AsmServiceOperation__RaisesAssignment_5_1");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getRaisesAssignment_5_2_1(), "rule__AsmServiceOperation__RaisesAssignment_5_2_1");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getGuardsAssignment_7_1(), "rule__AsmServiceOperation__GuardsAssignment_7_1");
			builder.put(grammarAccess.getAsmServiceOperationAccess().getEffectsAssignment_8_1(), "rule__AsmServiceOperation__EffectsAssignment_8_1");
			builder.put(grammarAccess.getAsmServiceParameterAccess().getDirectionAssignment_0(), "rule__AsmServiceParameter__DirectionAssignment_0");
			builder.put(grammarAccess.getAsmServiceParameterAccess().getNameAssignment_1(), "rule__AsmServiceParameter__NameAssignment_1");
			builder.put(grammarAccess.getAsmServiceParameterAccess().getTypeAssignment_3(), "rule__AsmServiceParameter__TypeAssignment_3");
			builder.put(grammarAccess.getAsmServiceParameterAccess().getMultiplicityAssignment_4(), "rule__AsmServiceParameter__MultiplicityAssignment_4");
			builder.put(grammarAccess.getAsmServiceParameterAccess().getDescriptionAssignment_5(), "rule__AsmServiceParameter__DescriptionAssignment_5");
			builder.put(grammarAccess.getAsmExceptionAccess().getNameAssignment_1(), "rule__AsmException__NameAssignment_1");
			builder.put(grammarAccess.getAsmExceptionAccess().getDescriptionAssignment_2(), "rule__AsmException__DescriptionAssignment_2");
