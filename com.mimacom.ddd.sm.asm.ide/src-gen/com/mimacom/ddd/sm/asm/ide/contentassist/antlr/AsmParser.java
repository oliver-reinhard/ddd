...
public class AsmParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AsmGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSServiceKindAccess().getAlternatives(), "rule__SServiceKind__Alternatives");
			builder.put(grammarAccess.getSDirectionAccess().getAlternatives(), "rule__SDirection__Alternatives");
			...
			builder.put(grammarAccess.getSServiceParameterAccess().getDirectionAssignment_0(), "rule__SServiceParameter__DirectionAssignment_0");
			builder.put(grammarAccess.getSServiceParameterAccess().getNameAssignment_1(), "rule__SServiceParameter__NameAssignment_1");
			builder.put(grammarAccess.getSServiceParameterAccess().getTypeAssignment_3(), "rule__SServiceParameter__TypeAssignment_3");
			builder.put(grammarAccess.getSServiceParameterAccess().getMultiplicityAssignment_4(), "rule__SServiceParameter__MultiplicityAssignment_4");
