...
public class AsmParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AsmGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAsmApplicationAccess().getModelAssignment_4(), "rule__AsmApplication__ModelAssignment_4");
			builder.put(grammarAccess.getAsmApplicationAccess().getActorsAssignment_5(), "rule__AsmApplication__ActorsAssignment_5");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getNameAssignment_2(), "rule__AsmServiceInterface__NameAssignment_2");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getInterfaceAssignment_5(), "rule__AsmServiceInterface__InterfaceAssignment_5");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getCoreAssignment_8(), "rule__AsmServiceInterface__CoreAssignment_8");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getExceptionsAssignment_9(), "rule__AsmServiceInterface__ExceptionsAssignment_9");
			builder.put(grammarAccess.getAsmServiceInterfaceAccess().getOperationsAssignment_10(), "rule__AsmServiceInterface__OperationsAssignment_10");
