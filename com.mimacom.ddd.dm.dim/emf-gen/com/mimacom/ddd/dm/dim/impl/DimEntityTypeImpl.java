 ...
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.dm.dim.impl.DimEntityTypeImpl#getTransposedBy <em>Transposed By</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DimEntityTypeImpl extends DEntityTypeImpl implements DimEntityType
{
	/**
	...
	{
		return DimPackage.Literals.DIM_ENTITY_TYPE;
	}
		...
		if (transposedBy != null && transposedBy.eIsProxy())
		{
			...
			if (transposedBy != oldTransposedBy)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DimPackage.DIM_ENTITY_TYPE__TRANSPOSED_BY, oldTransposedBy, transposedBy));
			}
		}
		return transposedBy;
	}
	...
	public void setTransposedBy(ITransposition newTransposedBy)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DimPackage.DIM_ENTITY_TYPE__TRANSPOSED_BY, oldTransposedBy, transposedBy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case DimPackage.DIM_ENTITY_TYPE__TRANSPOSED_BY:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == ITransposableElement.class)
		{
			...
			{
				case DimPackage.DIM_ENTITY_TYPE__TRANSPOSED_BY: return TransposePackage.ITRANSPOSABLE_ELEMENT__TRANSPOSED_BY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == ITransposableElement.class)
		{
			...
			{
				case TransposePackage.ITRANSPOSABLE_ELEMENT__TRANSPOSED_BY: return DimPackage.DIM_ENTITY_TYPE__TRANSPOSED_BY;
				default: return -1;
			}
		}
		if (baseClass == DimType.class)
