...
public class TransposedDimValidator extends DimValidator {
  @Inject
  @Extension
  ...
  public void checkCorrespondingAggregateType(final TAggregateTransposition a) {
    if (((a.getRule().getSource() != null) && (!(a.getRule().getSource() instanceof DAggregate)))) {
      this.error("Transposed-aggregate rule must have a domain-model Aggregate as its source", a.getRule(), 
  ...
  public void checkCorrespondingDEntityType(final TEntityTypeTransposition t) {
    ...
    if ((source instanceof DEntityType)) {
      ...
      if ((source != null)) {
        this.error("Transposed-entity rule must have a domain-model entity as its source", t.getRule(), 
          TransposePackage.Literals.TTRANSPOSITION_RULE__SOURCE);
      }
    }
  }
  ...
  public void checkCorrespondingDDetailType(final TDetailTypeTransposition t) {
    if (((t.getRule().getSource() != null) && (!(t.getRule().getSource() instanceof DDetailType)))) {
      this.error("Transposed-DetailType rule must have a domain-model DetailType as its source", t.getRule(), 
        TransposePackage.Literals.TTRANSPOSITION_RULE__SOURCE);
    }
  }
  ...
  @Check
  public void checkTransposedFeaturesCombination(final TComplexTypeTransposition t) {
    TTranspositionRule _rule = t.getRule();
    if ((_rule instanceof TGrabRule)) {
      final Iterable<TFeatureTransposition> featureRecipes = Iterables.<TFeatureTransposition>filter(((DComplexType) t).getFeatures(), TFeatureTransposition.class);
      ...
      final boolean hasDitchElements = IterableExtensions.<TFeatureTransposition>exists(featureRecipes, _function);
  ...
  public void checkComplexTypeExtensionChange(final TStructureChangingRule r) {
    ...
    if (_tripleNotEquals) {
      ...
      if ((container instanceof TComplexTypeTransposition)) {
        Class<? extends DType> _baseImplClass = this._dimUtil.baseImplClass(((TTypeTransposition)container));
  ...
  public void checkCorrespondingDAttributeType(final TAttributeTransposition a) {
    if (((a.getRule().getSource() != null) && (!(a.getRule().getSource() instanceof DAttribute)))) {
      this.error("Transposed attribute rule must have a domain-model attribute as its source", a.getRule(), 
        TransposePackage.Literals.TTRANSPOSITION_RULE__SOURCE);
    }
  }
  ...
  public void checkCorrespondingDAssociationType(final TAssociationTransposition a) {
    if (((a.getRule().getSource() != null) && (!(a.getRule().getSource() instanceof DAssociation)))) {
      this.error("Transposed association rule must have a domain-model association as its source", a.getRule(), 
        TransposePackage.Literals.TTRANSPOSITION_RULE__SOURCE);
    }
  }
  ...
  protected List<DType> allTypes(final DAggregate a) {
    if ((a instanceof TAggregateTransposition)) {
      ...
      types.addAll(this._dimUtil.syntheticTypes(((TAggregateTransposition)a)));
      return types;
    }
