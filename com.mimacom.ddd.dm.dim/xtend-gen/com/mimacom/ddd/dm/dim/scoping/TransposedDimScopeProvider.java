...
public class TransposedDimScopeProvider extends DimScopeProvider {
  @Inject
  @Extension
  ...
  public IScope getScope(final EObject context, final EReference reference) {
    ...
    {
      EReference _tTranspositionRule_Source = TransposedDimScopeProvider.TRANSPOSE.getTTranspositionRule_Source();
      ...
      if (_equals) {
        ...
        if ((decduction instanceof TAggregateTransposition)) {
          return this.getDefaultScopeOfType(decduction, TransposedDimScopeProvider.BASE.getDAggregate());
        } else {
          if ((decduction instanceof TPrimitiveTransposition)) {
            return this.getDefaultScopeOfType(decduction, TransposedDimScopeProvider.BASE.getDPrimitive());
          } else {
            if ((decduction instanceof TEntityTypeTransposition)) {
              return this.getDefaultScopeOfType(decduction, TransposedDimScopeProvider.BASE.getDEntityType());
            } else {
              if ((decduction instanceof TDetailTypeTransposition)) {
                return this.getDefaultScopeOfType(decduction, TransposedDimScopeProvider.BASE.getDDetailType());
              } else {
                  ...
                  if ((decduction instanceof TFeatureTransposition)) {
                    if ((container instanceof TComplexTypeTransposition)) {
                      ...
                      if ((sourceType_1 instanceof DComplexType)) {
                        final Class<? extends DFeature> requiredFeatureType = this._dimUtil.baseClass(((TFeatureTransposition)decduction));
  ...
  public IScope getDefaultScopeOfType(final EObject context, final EClass type) {
    if (((context instanceof DQuery) || (context instanceof DQueryParameter))) {
      ...
      if ((container instanceof TAggregateTransposition)) {
        final IScope outerScope = this.getDefaultScopeOfType(container, TransposedDimScopeProvider.BASE.getIValueType());
        final List<DType> syntheticTypes = this._dimUtil.syntheticTypes(((TAggregateTransposition)container));
