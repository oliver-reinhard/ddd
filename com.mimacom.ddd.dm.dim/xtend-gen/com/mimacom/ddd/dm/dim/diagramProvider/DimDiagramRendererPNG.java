...
public class DimDiagramRendererPNG implements IDiagramRenderer {
  @Override
  public InputStream render(final IDiagramRoot root) {
    StringConcatenation _builder = new StringConcatenation();
    String _name = DimDiagramRendererPNG.class.getName();
    _builder.append(_name);
    _builder.append(": EXECUTING");
    System.err.println(_builder);
    String _name_1 = DimDiagramRendererPNG.class.getName();
