...
public class PubGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class PubPublicationElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cPubGenerateParserRuleCall_6 = (RuleCall)cGroup.eContents().get(6);
		private final Assignment cSymbolsAssignment_7 = (Assignment)cGroup.eContents().get(7);
		private final RuleCall cSymbolsPubSymbolParserRuleCall_7_0 = (RuleCall)cSymbolsAssignment_7.eContents().get(0);
		private final Group cGroup_8 = (Group)cGroup.eContents().get(8);
		private final Keyword cIncludeKeyword_8_0 = (Keyword)cGroup_8.eContents().get(0);
		private final Assignment cIncludesAssignment_8_1 = (Assignment)cGroup_8.eContents().get(1);
		private final CrossReference cIncludesComponentCrossReference_8_1_0 = (CrossReference)cIncludesAssignment_8_1.eContents().get(0);
		private final RuleCall cIncludesComponentIDTerminalRuleCall_8_1_0_1 = (RuleCall)cIncludesComponentCrossReference_8_1_0.eContents().get(1);
		...
		//PubGenerate symbols+=PubSymbol* ('include:' includes+=[Component])*
		public Group getGroup() { return cGroup; }
		...
		//PubGenerate
		public RuleCall getPubGenerateParserRuleCall_6() { return cPubGenerateParserRuleCall_6; }
		
		//symbols+=PubSymbol*
		public Assignment getSymbolsAssignment_7() { return cSymbolsAssignment_7; }
		
		//PubSymbol
		public RuleCall getSymbolsPubSymbolParserRuleCall_7_0() { return cSymbolsPubSymbolParserRuleCall_7_0; }
		
		//('include:' includes+=[Component])*
		public Group getGroup_8() { return cGroup_8; }
		
		//'include:'
		public Keyword getIncludeKeyword_8_0() { return cIncludeKeyword_8_0; }
		
		//includes+=[Component]
		public Assignment getIncludesAssignment_8_1() { return cIncludesAssignment_8_1; }
		
		//[Component]
		public CrossReference getIncludesComponentCrossReference_8_1_0() { return cIncludesComponentCrossReference_8_1_0; }
		
		//ID
		public RuleCall getIncludesComponentIDTerminalRuleCall_8_1_0_1() { return cIncludesComponentIDTerminalRuleCall_8_1_0_1; }
	}
	public class PubComponentElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cSymbolsAssignment_7 = (Assignment)cGroup.eContents().get(7);
		private final RuleCall cSymbolsPubSymbolParserRuleCall_7_0 = (RuleCall)cSymbolsAssignment_7.eContents().get(0);
		private final Assignment cSegmentsAssignment_8 = (Assignment)cGroup.eContents().get(8);
		private final RuleCall cSegmentsPubDocumentSegmentParserRuleCall_8_0 = (RuleCall)cSegmentsAssignment_8.eContents().get(0);
		...
		//PubGenerate symbols+=PubSymbol* segments+=PubDocumentSegment*
		public Group getGroup() { return cGroup; }
		...
		//segments+=PubDocumentSegment*
		public Assignment getSegmentsAssignment_8() { return cSegmentsAssignment_8; }
		
		//PubDocumentSegment
		public RuleCall getSegmentsPubDocumentSegmentParserRuleCall_8_0() { return cSegmentsPubDocumentSegmentParserRuleCall_8_0; }
	}
	public class PubGenerateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.mimacom.ddd.pub.pub.Pub.PubGenerate");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cGenerateKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final UnorderedGroup cUnorderedGroup_1 = (UnorderedGroup)cGroup.eContents().get(1);
		private final Assignment cGenerateHtmlAssignment_1_0 = (Assignment)cUnorderedGroup_1.eContents().get(0);
		private final Keyword cGenerateHtmlHtmlKeyword_1_0_0 = (Keyword)cGenerateHtmlAssignment_1_0.eContents().get(0);
		private final Assignment cGenerateLaTeXAssignment_1_1 = (Assignment)cUnorderedGroup_1.eContents().get(1);
		private final Keyword cGenerateLaTeXLatexKeyword_1_1_0 = (Keyword)cGenerateLaTeXAssignment_1_1.eContents().get(0);
		private final Group cGroup_2 = (Group)cGroup.eContents().get(2);
		private final Keyword cDiagramsKeyword_2_0 = (Keyword)cGroup_2.eContents().get(0);
		private final Alternatives cAlternatives_2_1 = (Alternatives)cGroup_2.eContents().get(1);
		private final Assignment cPreferRasterDiagramsAssignment_2_1_0 = (Assignment)cAlternatives_2_1.eContents().get(0);
		private final Keyword cPreferRasterDiagramsRasterKeyword_2_1_0_0 = (Keyword)cPreferRasterDiagramsAssignment_2_1_0.eContents().get(0);
		private final Keyword cVectorKeyword_2_1_1 = (Keyword)cAlternatives_2_1.eContents().get(1);
		...
		//generateHtml?='html'?
		public Assignment getGenerateHtmlAssignment_1_0() { return cGenerateHtmlAssignment_1_0; }
		
		//'html'
		public Keyword getGenerateHtmlHtmlKeyword_1_0_0() { return cGenerateHtmlHtmlKeyword_1_0_0; }
		
		//generateLaTeX?='latex'?
		public Assignment getGenerateLaTeXAssignment_1_1() { return cGenerateLaTeXAssignment_1_1; }
		
		//'latex'
		public Keyword getGenerateLaTeXLatexKeyword_1_1_0() { return cGenerateLaTeXLatexKeyword_1_1_0; }
		
		//('diagrams:' (preferRasterDiagrams?='raster' | 'vector'))?
		public Group getGroup_2() { return cGroup_2; }
		
		//'diagrams:'
		public Keyword getDiagramsKeyword_2_0() { return cDiagramsKeyword_2_0; }
		
		//(preferRasterDiagrams?='raster' | 'vector')
		public Alternatives getAlternatives_2_1() { return cAlternatives_2_1; }
		
		//preferRasterDiagrams?='raster'
		public Assignment getPreferRasterDiagramsAssignment_2_1_0() { return cPreferRasterDiagramsAssignment_2_1_0; }
		
		//'raster'
		public Keyword getPreferRasterDiagramsRasterKeyword_2_1_0_0() { return cPreferRasterDiagramsRasterKeyword_2_1_0_0; }
		
		//'vector'
		public Keyword getVectorKeyword_2_1_1() { return cVectorKeyword_2_1_1; }
	}
	...
	public class PubPublicationBodyElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cDivisionsPubSectionParserRuleCall_3_0_3 = (RuleCall)cDivisionsAlternatives_3_0.eContents().get(3);
		private final Keyword cRightCurlyBracketKeyword_4 = (Keyword)cGroup.eContents().get(4);
		...
		//{PublicationBody} 'Body' '{' divisions+=(PubPart | PubAppendix | PubChapter | PubSection)* '}'
		public Group getGroup() { return cGroup; }
		...
		//(PubPart | PubAppendix | PubChapter | PubSection)
		...
		//PubSection
		public RuleCall getDivisionsPubSectionParserRuleCall_3_0_3() { return cDivisionsPubSectionParserRuleCall_3_0_3; }
	...
	public class PubContentBlockElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cPubFootnoteParserRuleCall_7 = (RuleCall)cAlternatives.eContents().get(7);
		...
		//PubFootnote
		public RuleCall getPubFootnoteParserRuleCall_7() { return cPubFootnoteParserRuleCall_7; }
	}
	...
	public class PubListElements extends AbstractParserRuleElementFinder {
		...
		//{List2} 'List' ('(' '#'? name=ID ')')? ('style:' style=PubListStyle)? ('numbering:'
	...
	public class ProvidedFigureElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cDiagramTypeAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final CrossReference cDiagramTypeProvidedDiagramTypeCrossReference_4_0 = (CrossReference)cDiagramTypeAssignment_4.eContents().get(0);
		private final RuleCall cDiagramTypeProvidedDiagramTypeDQualifiedNameParserRuleCall_4_0_1 = (RuleCall)cDiagramTypeProvidedDiagramTypeCrossReference_4_0.eContents().get(1);
		...
		//diagramType=[ProvidedDiagramType|DQualifiedName]
		public Group getGroup() { return cGroup; }
		...
		//diagramType=[ProvidedDiagramType|DQualifiedName]
		public Assignment getDiagramTypeAssignment_4() { return cDiagramTypeAssignment_4; }
		
		//[ProvidedDiagramType|DQualifiedName]
		public CrossReference getDiagramTypeProvidedDiagramTypeCrossReference_4_0() { return cDiagramTypeProvidedDiagramTypeCrossReference_4_0; }
		
		//DQualifiedName
		public RuleCall getDiagramTypeProvidedDiagramTypeDQualifiedNameParserRuleCall_4_0_1() { return cDiagramTypeProvidedDiagramTypeDQualifiedNameParserRuleCall_4_0_1; }
	}
	...
	public class PubFootnoteElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.mimacom.ddd.pub.pub.Pub.PubFootnote");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cFootnoteKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cNameIDTerminalRuleCall_1_0 = (RuleCall)cNameAssignment_1.eContents().get(0);
		private final Assignment cTextAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cTextDRichTextParserRuleCall_2_0 = (RuleCall)cTextAssignment_2.eContents().get(0);
		...
		//'Footnote' name=ID text=DRichText
		public Group getGroup() { return cGroup; }
		
		//'Footnote'
		public Keyword getFootnoteKeyword_0() { return cFootnoteKeyword_0; }
	...
	public class DmxPrimaryExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cDmxUrlLiteralParserRuleCall_8 = (RuleCall)cAlternatives.eContents().get(8);
		...
		//DmxUrlLiteral
		public RuleCall getDmxUrlLiteralParserRuleCall_8() { return cDmxUrlLiteralParserRuleCall_8; }
	}
	...
	public class PubReferenceScopeElements extends AbstractEnumRuleElementFinder {
		...
		private final EnumLiteralDeclaration cFootnoteEnumLiteralDeclaration_8 = (EnumLiteralDeclaration)cAlternatives.eContents().get(8);
		private final Keyword cFootnoteFootnoteKeyword_8_0 = (Keyword)cFootnoteEnumLiteralDeclaration_8.eContents().get(0);
		private final EnumLiteralDeclaration cListItemEnumLiteralDeclaration_9 = (EnumLiteralDeclaration)cAlternatives.eContents().get(9);
		private final Keyword cListItemItemKeyword_9_0 = (Keyword)cListItemEnumLiteralDeclaration_9.eContents().get(0);
		private final EnumLiteralDeclaration cTableEnumLiteralDeclaration_10 = (EnumLiteralDeclaration)cAlternatives.eContents().get(10);
		private final Keyword cTableTableKeyword_10_0 = (Keyword)cTableEnumLiteralDeclaration_10.eContents().get(0);
		private final EnumLiteralDeclaration cFigureEnumLiteralDeclaration_11 = (EnumLiteralDeclaration)cAlternatives.eContents().get(11);
		private final Keyword cFigureFigureKeyword_11_0 = (Keyword)cFigureEnumLiteralDeclaration_11.eContents().get(0);
		private final EnumLiteralDeclaration cEquationEnumLiteralDeclaration_12 = (EnumLiteralDeclaration)cAlternatives.eContents().get(12);
		private final Keyword cEquationEquationKeyword_12_0 = (Keyword)cEquationEnumLiteralDeclaration_12.eContents().get(0);
		private final EnumLiteralDeclaration cCodeListingEnumLiteralDeclaration_13 = (EnumLiteralDeclaration)cAlternatives.eContents().get(13);
		private final Keyword cCodeListingCodeKeyword_13_0 = (Keyword)cCodeListingEnumLiteralDeclaration_13.eContents().get(0);
		private final EnumLiteralDeclaration cAdmonitionEnumLiteralDeclaration_14 = (EnumLiteralDeclaration)cAlternatives.eContents().get(14);
		private final Keyword cAdmonitionAdmonitionKeyword_14_0 = (Keyword)cAdmonitionEnumLiteralDeclaration_14.eContents().get(0);
		private final EnumLiteralDeclaration cAbbreviationEnumLiteralDeclaration_15 = (EnumLiteralDeclaration)cAlternatives.eContents().get(15);
		private final Keyword cAbbreviationAbbrevKeyword_15_0 = (Keyword)cAbbreviationEnumLiteralDeclaration_15.eContents().get(0);
		private final EnumLiteralDeclaration cGlossaryEnumLiteralDeclaration_16 = (EnumLiteralDeclaration)cAlternatives.eContents().get(16);
		private final Keyword cGlossaryGlossaryKeyword_16_0 = (Keyword)cGlossaryEnumLiteralDeclaration_16.eContents().get(0);
		private final EnumLiteralDeclaration cBibliographyEnumLiteralDeclaration_17 = (EnumLiteralDeclaration)cAlternatives.eContents().get(17);
		private final Keyword cBibliographyBilioKeyword_17_0 = (Keyword)cBibliographyEnumLiteralDeclaration_17.eContents().get(0);
		...
		//Subsection='sub' | Subsubsection='subsub' | Footnote='footnote' | ListItem='item' | Table='table' | Figure='figure' |
		//Equation='equation' | CodeListing='code' | Admonition='admonition' | Abbreviation='abbrev' | Glossary='glossary' |
		//Bibliography='bilio'
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//Footnote='footnote'
		public EnumLiteralDeclaration getFootnoteEnumLiteralDeclaration_8() { return cFootnoteEnumLiteralDeclaration_8; }
		
		//'footnote'
		public Keyword getFootnoteFootnoteKeyword_8_0() { return cFootnoteFootnoteKeyword_8_0; }
		
		//ListItem='item'
		public EnumLiteralDeclaration getListItemEnumLiteralDeclaration_9() { return cListItemEnumLiteralDeclaration_9; }
		
		//'item'
		public Keyword getListItemItemKeyword_9_0() { return cListItemItemKeyword_9_0; }
		
		//Table='table'
		public EnumLiteralDeclaration getTableEnumLiteralDeclaration_10() { return cTableEnumLiteralDeclaration_10; }
		
		//'table'
		public Keyword getTableTableKeyword_10_0() { return cTableTableKeyword_10_0; }
		
		//Figure='figure'
		public EnumLiteralDeclaration getFigureEnumLiteralDeclaration_11() { return cFigureEnumLiteralDeclaration_11; }
		
		//'figure'
		public Keyword getFigureFigureKeyword_11_0() { return cFigureFigureKeyword_11_0; }
		
		//Equation='equation'
		public EnumLiteralDeclaration getEquationEnumLiteralDeclaration_12() { return cEquationEnumLiteralDeclaration_12; }
		
		//'equation'
		public Keyword getEquationEquationKeyword_12_0() { return cEquationEquationKeyword_12_0; }
		
		//CodeListing='code'
		public EnumLiteralDeclaration getCodeListingEnumLiteralDeclaration_13() { return cCodeListingEnumLiteralDeclaration_13; }
		
		//'code'
		public Keyword getCodeListingCodeKeyword_13_0() { return cCodeListingCodeKeyword_13_0; }
		
		//Admonition='admonition'
		public EnumLiteralDeclaration getAdmonitionEnumLiteralDeclaration_14() { return cAdmonitionEnumLiteralDeclaration_14; }
		
		//'admonition'
		public Keyword getAdmonitionAdmonitionKeyword_14_0() { return cAdmonitionAdmonitionKeyword_14_0; }
		
		//Abbreviation='abbrev'
		public EnumLiteralDeclaration getAbbreviationEnumLiteralDeclaration_15() { return cAbbreviationEnumLiteralDeclaration_15; }
		
		//'abbrev'
		public Keyword getAbbreviationAbbrevKeyword_15_0() { return cAbbreviationAbbrevKeyword_15_0; }
		
		//Glossary='glossary'
		public EnumLiteralDeclaration getGlossaryEnumLiteralDeclaration_16() { return cGlossaryEnumLiteralDeclaration_16; }
		
		//'glossary'
		public Keyword getGlossaryGlossaryKeyword_16_0() { return cGlossaryGlossaryKeyword_16_0; }
		
		//Bibliography='bilio'
		public EnumLiteralDeclaration getBibliographyEnumLiteralDeclaration_17() { return cBibliographyEnumLiteralDeclaration_17; }
		
		//'bilio'
		public Keyword getBibliographyBilioKeyword_17_0() { return cBibliographyBilioKeyword_17_0; }
	}
	...
	private final PubGenerateElements pPubGenerate;
	...
	public PubGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pPubGenerate = new PubGenerateElements();
	...
	//	/* & generateMarkdown?='markdown'? & generateAsciiDoc?='asciidoc'? */) ('diagrams:' (preferRasterDiagrams?='raster' |
	//	'vector'))?;
	public PubGenerateElements getPubGenerateAccess() {
		return pPubGenerate;
	}
	...
	//	name=ID
	//	text=DRichText;
	public PubFootnoteElements getPubFootnoteAccess() {
		return pPubFootnote;
	}
