...
public class PubSemanticSequencer extends DmxSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == BasePackage.eINSTANCE)
			...
			case PubPackage.LIST2:
				sequence_PubList(context, (List2) semanticObject); 
				return; 
	 ...
	 *
	 * Constraint:
	 *     (widthPercent=NATURAL? diagramRoot=[IDiagramRoot|DQualifiedName] diagramType=[ProvidedDiagramType|DQualifiedName])
	 */
	 ...
	 *         (generateHtml?='html' | generateLaTeX?='latex')* 
	...
	/**
	 * Contexts:
	 *     PubContentBlock returns Footnote
	 *     PubFootnote returns Footnote
	 *
	 * Constraint:
	 *     (name=ID text=DRichText)
	 */
	protected void sequence_PubFootnote(ISerializationContext context, Footnote semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PubPackage.Literals.REFERENCE_TARGET__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PubPackage.Literals.REFERENCE_TARGET__NAME));
			if (transientValues.isValueTransient(semanticObject, PubPackage.Literals.FOOTNOTE__TEXT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PubPackage.Literals.FOOTNOTE__TEXT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPubFootnoteAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getPubFootnoteAccess().getTextDRichTextParserRuleCall_2_0(), semanticObject.getText());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     PubContentBlock returns List2
	 *     PubList returns List2
	 *
	 * Constraint:
	 *     (name=ID? style=PubListStyle? numberingStyle=PubSequenceNumberStyle? items+=PubListItem*)
	 */
	protected void sequence_PubList(ISerializationContext context, List2 semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
