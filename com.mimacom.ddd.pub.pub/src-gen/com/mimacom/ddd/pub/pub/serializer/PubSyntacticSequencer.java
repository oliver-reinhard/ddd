...
public class PubSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_PubGenerate_GenerateKeyword_0_0_a;
	protected AbstractElementAlias match_PubGenerate_GenerateKeyword_0_0_p;
	...
	protected void init(IGrammarAccess access) {
		...
		match_PubGenerate_GenerateKeyword_0_0_a = new TokenAlias(true, true, grammarAccess.getPubGenerateAccess().getGenerateKeyword_0_0());
		match_PubGenerate_GenerateKeyword_0_0_p = new TokenAlias(true, false, grammarAccess.getPubGenerateAccess().getGenerateKeyword_0_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_PubGenerate_GenerateKeyword_0_0_a.equals(syntax))
				emit_PubGenerate_GenerateKeyword_0_0_a(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_PubGenerate_GenerateKeyword_0_0_p.equals(syntax))
				emit_PubGenerate_GenerateKeyword_0_0_p(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     generateAsciiDoc?='asciidoc' (ambiguity) 'include:' includes+=[Component|ID]
	 *     generateAsciiDoc?='asciidoc' (ambiguity) (rule end)
	 *     generateAsciiDoc?='asciidoc' (ambiguity) generateAsciiDoc?='asciidoc'
	 *     generateAsciiDoc?='asciidoc' (ambiguity) generateLaTeX?='latex'
	 *     generateAsciiDoc?='asciidoc' (ambiguity) generateMarkdown?='markdown'
	 *     generateAsciiDoc?='asciidoc' (ambiguity) segments+=PubDocumentSegment
	 *     generateAsciiDoc?='asciidoc' (ambiguity) symbols+=PubSymbol
	 *     generateHtml?='html' (ambiguity) 'include:' includes+=[Component|ID]
	 *     generateHtml?='html' (ambiguity) (rule end)
	 *     generateHtml?='html' (ambiguity) generateAsciiDoc?='asciidoc'
	 *     generateHtml?='html' (ambiguity) generateLaTeX?='latex'
	 *     generateHtml?='html' (ambiguity) generateMarkdown?='markdown'
	 ...
	 *     generateLaTeX?='latex' (ambiguity) generateAsciiDoc?='asciidoc'
	 *     generateLaTeX?='latex' (ambiguity) generateLaTeX?='latex'
	 *     generateLaTeX?='latex' (ambiguity) generateMarkdown?='markdown'
	 *     generateLaTeX?='latex' (ambiguity) segments+=PubDocumentSegment
	 *     generateLaTeX?='latex' (ambiguity) symbols+=PubSymbol
	 *     generateMarkdown?='markdown' (ambiguity) 'include:' includes+=[Component|ID]
	 *     generateMarkdown?='markdown' (ambiguity) (rule end)
	 *     generateMarkdown?='markdown' (ambiguity) generateAsciiDoc?='asciidoc'
	 *     generateMarkdown?='markdown' (ambiguity) generateLaTeX?='latex'
	 *     generateMarkdown?='markdown' (ambiguity) generateMarkdown?='markdown'
	 *     generateMarkdown?='markdown' (ambiguity) segments+=PubDocumentSegment
	 *     generateMarkdown?='markdown' (ambiguity) symbols+=PubSymbol
	 *     publicationClass=[PublicationClass|ID] (ambiguity) 'include:' includes+=[Component|ID]
	 *     publicationClass=[PublicationClass|ID] (ambiguity) (rule end)
	 *     publicationClass=[PublicationClass|ID] (ambiguity) generateAsciiDoc?='asciidoc'
	 *     publicationClass=[PublicationClass|ID] (ambiguity) generateLaTeX?='latex'
	 *     publicationClass=[PublicationClass|ID] (ambiguity) generateMarkdown?='markdown'
	 *     publicationClass=[PublicationClass|ID] (ambiguity) segments+=PubDocumentSegment
	 *     publicationClass=[PublicationClass|ID] (ambiguity) symbols+=PubSymbol
	 */
	protected void emit_PubGenerate_GenerateKeyword_0_0_a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     generateAsciiDoc?='asciidoc' (ambiguity) generateHtml?='html'
	 *     generateHtml?='html' (ambiguity) generateHtml?='html'
	 *     generateLaTeX?='latex' (ambiguity) generateHtml?='html'
	 *     generateMarkdown?='markdown' (ambiguity) generateHtml?='html'
	 *     publicationClass=[PublicationClass|ID] (ambiguity) generateHtml?='html'
	 */
	protected void emit_PubGenerate_GenerateKeyword_0_0_p(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
