...
abstract class AbstractPubRenderer {
	...
	abstract def PubGeneratorTarget target()
...
//	abstract def CharSequence renderReferenceTo(ReferenceTarget target, String linkText)
	...
	abstract def IDiagramFileFormatPreference diagramFileFormatPreference()

	abstract def CharSequence renderEquation(Equation e)

	abstract def CharSequence renderCodeListing(TitledCodeListing cl, String outdentedListing)
