...
public class PubHtmlDiagramFileFormatPreference implements IDiagramFileFormatPreference {
  @Override
  ...
  public List<DiagramFileFormat> vector() {
    return Collections.<DiagramFileFormat>unmodifiableList(CollectionLiterals.<DiagramFileFormat>newArrayList(DiagramFileFormat.SVG, DiagramFileFormat.EPS));
  }
}
