...
public class PubPackageImpl extends EPackageImpl implements PubPackage {
	...
	public void createPackageContents() {
		...
		createEAttribute(tableEClass, TABLE__WIDTH_PERCENT);
	...
	public void initializePackageContents() {
		...
		tableEClass.getESuperTypes().add(this.getTitledBlock());
		tableCellEClass.getESuperTypes().add(this.getBlockContainer());
		figureEClass.getESuperTypes().add(this.getTitledBlock());
		...
		initEAttribute(getTable_WidthPercent(), theEcorePackage.getEInt(), "widthPercent", "100", 0, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
