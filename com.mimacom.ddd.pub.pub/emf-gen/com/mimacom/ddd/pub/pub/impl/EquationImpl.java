 ...
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.pub.pub.impl.EquationImpl#getFileUri <em>File Uri</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EquationImpl extends TitledBlockImpl implements Equation {
	/**
	...
	protected EClass eStaticClass() {
		return PubPackage.Literals.EQUATION;
	}
	...
	public void setFileUri(String newFileUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PubPackage.EQUATION__FILE_URI, oldFileUri, fileUri));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PubPackage.EQUATION__FILE_URI:
				return getFileUri();
		}
