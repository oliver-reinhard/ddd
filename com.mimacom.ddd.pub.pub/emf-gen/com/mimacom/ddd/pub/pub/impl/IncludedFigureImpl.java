...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Included Figure</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.pub.pub.impl.IncludedFigureImpl#getFileUri <em>File Uri</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IncludedFigureImpl extends AbstractFigureImpl implements IncludedFigure {
	/**
	...
	protected EClass eStaticClass() {
		return PubPackage.Literals.INCLUDED_FIGURE;
	}
	...
	public void setFileUri(String newFileUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PubPackage.INCLUDED_FIGURE__FILE_URI, oldFileUri, fileUri));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PubPackage.INCLUDED_FIGURE__FILE_URI:
				return getFileUri();
		}
