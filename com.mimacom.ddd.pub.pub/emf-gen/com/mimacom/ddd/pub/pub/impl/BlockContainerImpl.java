 ...
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.pub.pub.impl.BlockContainerImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BlockContainerImpl extends MinimalEObjectImpl.Container implements BlockContainer {
	...
	protected EClass eStaticClass() {
		return PubPackage.Literals.BLOCK_CONTAINER;
	}
	...
	public EList<ContentBlock> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<ContentBlock>(ContentBlock.class, this, PubPackage.BLOCK_CONTAINER__CONTENTS);
		}
		return contents;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PubPackage.BLOCK_CONTAINER__CONTENTS:
