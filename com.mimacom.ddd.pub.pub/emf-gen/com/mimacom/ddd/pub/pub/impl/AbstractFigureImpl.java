 ...
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.pub.pub.impl.AbstractFigureImpl#getWidthPercent <em>Width Percent</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractFigureImpl extends MinimalEObjectImpl.Container implements AbstractFigure {
	/**
	...
	protected EClass eStaticClass() {
		return PubPackage.Literals.ABSTRACT_FIGURE;
	}
	...
	public void setWidthPercent(int newWidthPercent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PubPackage.ABSTRACT_FIGURE__WIDTH_PERCENT, oldWidthPercent, widthPercent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PubPackage.ABSTRACT_FIGURE__WIDTH_PERCENT:
