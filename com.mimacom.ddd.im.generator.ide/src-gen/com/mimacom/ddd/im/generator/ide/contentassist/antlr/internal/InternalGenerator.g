...
:
	(
		{ before(grammarAccess.getEndpointDeclarationAccess().getPathPathIDParserRuleCall_4_1_1_0()); }
		rulePathID
		{ after(grammarAccess.getEndpointDeclarationAccess().getPathPathIDParserRuleCall_4_1_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
