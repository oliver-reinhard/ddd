 ...
 */
package com.mimacom.ddd.im.generator.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import com.mimacom.ddd.im.generator.ide.contentassist.antlr.internal.InternalGeneratorParser;
...
public class GeneratorParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GeneratorGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getHttpVerbAccess().getAlternatives(), "rule__HttpVerb__Alternatives");
			...
			builder.put(grammarAccess.getExceptionMappingAccess().getGroup_4(), "rule__ExceptionMapping__Group_4__0");
			builder.put(grammarAccess.getExceptionMappingAccess().getGroup_5(), "rule__ExceptionMapping__Group_5__0");
			builder.put(grammarAccess.getEndpointDeclarationBlockAccess().getGroup(), "rule__EndpointDeclarationBlock__Group__0");
			builder.put(grammarAccess.getEndpointDeclarationBlockAccess().getGroup_3(), "rule__EndpointDeclarationBlock__Group_3__0");
			...
			builder.put(grammarAccess.getModelAccess().getImportSectionAssignment_3(), "rule__Model__ImportSectionAssignment_3");
			builder.put(grammarAccess.getModelAccess().getTypeMappingsAssignment_4_0_3(), "rule__Model__TypeMappingsAssignment_4_0_3");
			builder.put(grammarAccess.getModelAccess().getExceptionMappingsAssignment_4_1_3(), "rule__Model__ExceptionMappingsAssignment_4_1_3");
			builder.put(grammarAccess.getModelAccess().getEndpointDeclarationsAssignment_4_2(), "rule__Model__EndpointDeclarationsAssignment_4_2");
			builder.put(grammarAccess.getTypeMappingAccess().getNameAssignment_1(), "rule__TypeMapping__NameAssignment_1");
			builder.put(grammarAccess.getTypeMappingAccess().getTypeAssignment_3(), "rule__TypeMapping__TypeAssignment_3");
			builder.put(grammarAccess.getTypeMappingAccess().getJavaTypeAssignment_6(), "rule__TypeMapping__JavaTypeAssignment_6");
			builder.put(grammarAccess.getExceptionMappingAccess().getNameAssignment_1(), "rule__ExceptionMapping__NameAssignment_1");
			builder.put(grammarAccess.getExceptionMappingAccess().getTypeAssignment_3(), "rule__ExceptionMapping__TypeAssignment_3");
			builder.put(grammarAccess.getExceptionMappingAccess().getExtendsAssignment_4_1(), "rule__ExceptionMapping__ExtendsAssignment_4_1");
			builder.put(grammarAccess.getExceptionMappingAccess().getMessageAssignment_5_1(), "rule__ExceptionMapping__MessageAssignment_5_1");
			builder.put(grammarAccess.getEndpointDeclarationBlockAccess().getNameAssignment_2(), "rule__EndpointDeclarationBlock__NameAssignment_2");
			builder.put(grammarAccess.getEndpointDeclarationBlockAccess().getPathAssignment_3_1(), "rule__EndpointDeclarationBlock__PathAssignment_3_1");
			builder.put(grammarAccess.getEndpointDeclarationBlockAccess().getEndpointsAssignment_5(), "rule__EndpointDeclarationBlock__EndpointsAssignment_5");
			builder.put(grammarAccess.getEndpointDeclarationAccess().getVerbAssignment_0(), "rule__EndpointDeclaration__VerbAssignment_0");
