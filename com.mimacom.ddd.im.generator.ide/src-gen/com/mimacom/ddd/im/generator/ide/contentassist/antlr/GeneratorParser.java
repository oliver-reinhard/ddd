...
public class GeneratorParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GeneratorGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEndpointDeclarationAccess().getGroup_2(), "rule__EndpointDeclaration__Group_2__0");
			builder.put(grammarAccess.getEndpointDeclarationAccess().getGroup_2_1(), "rule__EndpointDeclaration__Group_2_1__0");
			...
			builder.put(grammarAccess.getEndpointDeclarationAccess().getPathAssignment_2_1_1(), "rule__EndpointDeclaration__PathAssignment_2_1_1");
