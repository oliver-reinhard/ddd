...
import com.mimacom.ddd.sm.sms.derivedState.TransformationContext.UnsupportedDomainTypeException
...
class SmsDerivedStateComputer implements IDerivedStateComputer {
	...
	static Logger LOGGER = Logger.getLogger(SmsDerivedStateComputer);
