	...
	(
		(
			...
			(
				...
				{
					$current = $this_SComplexTypeExtends_15.current;
					afterParserOrEnumRuleCall();
				}
			)
		)
		...
		{
			$current = $this_SComplexTypeFeatures_16.current;
			afterParserOrEnumRuleCall();
		}
	)
;
