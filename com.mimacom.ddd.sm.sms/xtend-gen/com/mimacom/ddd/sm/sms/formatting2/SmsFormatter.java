...
public class SmsFormatter extends AbstractFormatter2 {
  @Inject
  @Extension
  private SmsGrammarAccess _smsGrammarAccess;
  
  protected void _format(final SDomain domain, @Extension final IFormattableDocument document) {
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.setNewLines(2);
    };
    document.append(this.textRegionExtensions.regionFor(domain).assignment(this._smsGrammarAccess.getSDomainAccess().getNameAssignment_1()), _function);
  ...
  protected void _format(final SAggregate aggregate, @Extension final IFormattableDocument document) {
    final ISemanticRegion open = this.textRegionExtensions.regionFor(aggregate).keyword(this._smsGrammarAccess.getSAggregateAccess().getLeftCurlyBracketKeyword_1_1_1());
    final ISemanticRegion close = this.textRegionExtensions.regionFor(aggregate).keyword(this._smsGrammarAccess.getSAggregateAccess().getRightCurlyBracketKeyword_1_1_3());
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.setNewLines(2);
    };
  ...
  protected void _format(final SEnumeration en, @Extension final IFormattableDocument document) {
    ...
    if (_greaterThan) {
      final ISemanticRegion open = this.textRegionExtensions.regionFor(en).keyword(this._smsGrammarAccess.getSEnumerationAccess().getLeftCurlyBracketKeyword_1());
      final ISemanticRegion close = this.textRegionExtensions.regionFor(en).keyword(this._smsGrammarAccess.getSEnumerationAccess().getRightCurlyBracketKeyword_4());
      final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
        it.newLine();
      };
      document.append(open, _function);
      ...
      for (final SLiteral literal : _literals) {
        ...
        document.surround(this.textRegionExtensions.regionFor(literal).assignment(this._smsGrammarAccess.getSLiteralAccess().getNameAssignment_2()), _function_2);
      }
      List<ISemanticRegion> _keywords = this.textRegionExtensions.regionFor(en).keywords(this._smsGrammarAccess.getSEnumerationAccess().getCommaKeyword_2_1_0());
  ...
  protected void _format(final SComplexType type, @Extension final IFormattableDocument document) {
    final ISemanticRegion open = this.textRegionExtensions.regionFor(type).keyword(this._smsGrammarAccess.getSComplexTypeFeaturesAccess().getLeftCurlyBracketKeyword_0());
    final ISemanticRegion close = this.textRegionExtensions.regionFor(type).keyword(this._smsGrammarAccess.getSComplexTypeFeaturesAccess().getRightCurlyBracketKeyword_2());
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.newLine();
    };
    document.append(open, _function);
