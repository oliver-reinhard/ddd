 ...
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.sm.sms.impl.SAttributeImpl#isDetail <em>Detail</em>}</li>
 *   <li>{@link com.mimacom.ddd.sm.sms.impl.SAttributeImpl#isKey <em>Key</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SAttributeImpl extends SFeatureImpl implements SAttribute
{
	...
	{
		return SmsPackage.Literals.SATTRIBUTE;
	}
	...
	public void setDetail(boolean newDetail)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmsPackage.SATTRIBUTE__DETAIL, oldDetail, detail));
	}
	...
	public void setKey(boolean newKey)
	{
		...
		key = newKey;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmsPackage.SATTRIBUTE__KEY, oldKey, key));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case SmsPackage.SATTRIBUTE__DETAIL:
				return isDetail();
			case SmsPackage.SATTRIBUTE__KEY:
				return isKey();
		}
