 ...
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.sm.sms.impl.SMultiplicityImpl#getMinOccurs <em>Min Occurs</em>}</li>
 *   <li>{@link com.mimacom.ddd.sm.sms.impl.SMultiplicityImpl#getMaxOccurs <em>Max Occurs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SMultiplicityImpl extends MinimalEObjectImpl.Container implements SMultiplicity
{
	...
	{
		return SmsPackage.Literals.SMULTIPLICITY;
	}
	...
	public void setMinOccurs(int newMinOccurs)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmsPackage.SMULTIPLICITY__MIN_OCCURS, oldMinOccurs, minOccurs));
	}
	...
	public void setMaxOccurs(int newMaxOccurs)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmsPackage.SMULTIPLICITY__MAX_OCCURS, oldMaxOccurs, maxOccurs));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case SmsPackage.SMULTIPLICITY__MIN_OCCURS:
				return getMinOccurs();
			case SmsPackage.SMULTIPLICITY__MAX_OCCURS:
				return getMaxOccurs();
		}
