...
public class DivParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DivGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getDomainInformationViewAccess().getAlternatives_8(), "rule__DomainInformationView__Alternatives_8");
			builder.put(grammarAccess.getDivAggregateAccess().getAlternatives(), "rule__DivAggregate__Alternatives");
			builder.put(grammarAccess.getDivAggregateTranspositionAccess().getAlternatives_5_1(), "rule__DivAggregateTransposition__Alternatives_5_1");
			...
			builder.put(grammarAccess.getDomainInformationViewAccess().getGroup_3(), "rule__DomainInformationView__Group_3__0");
			builder.put(grammarAccess.getDomainInformationViewAccess().getGroup_4(), "rule__DomainInformationView__Group_4__0");
			...
			builder.put(grammarAccess.getDivMorphComplexTypeRuleAccess().getGroup(), "rule__DivMorphComplexTypeRule__Group__0");
			...
			builder.put(grammarAccess.getDivAggregateTranspositionAccess().getGroup_5_1_1(), "rule__DivAggregateTransposition__Group_5_1_1__0");
			...
			builder.put(grammarAccess.getDivPrimitiveTranspositionAccess().getGroup_4(), "rule__DivPrimitiveTransposition__Group_4__0");
			builder.put(grammarAccess.getDivPrimitiveTranspositionAccess().getGroup_4_1(), "rule__DivPrimitiveTransposition__Group_4_1__0");
			...
			builder.put(grammarAccess.getDivEnumerationTranspositionAccess().getGroup_4(), "rule__DivEnumerationTransposition__Group_4__0");
			builder.put(grammarAccess.getDivEnumerationTranspositionAccess().getGroup_4_1(), "rule__DivEnumerationTransposition__Group_4_1__0");
			builder.put(grammarAccess.getDivEnumerationTranspositionAccess().getGroup_4_1_1(), "rule__DivEnumerationTransposition__Group_4_1_1__0");
			builder.put(grammarAccess.getDivEnumerationTranspositionAccess().getGroup_4_2(), "rule__DivEnumerationTransposition__Group_4_2__0");
			...
			builder.put(grammarAccess.getDivFeatureAccess().getGroup_3(), "rule__DivFeature__Group_3__0");
			...
			builder.put(grammarAccess.getDomainInformationViewAccess().getAliasAssignment_3_1(), "rule__DomainInformationView__AliasAssignment_3_1");
			builder.put(grammarAccess.getDomainInformationViewAccess().getReadOnlyViewAssignment_4_0(), "rule__DomainInformationView__ReadOnlyViewAssignment_4_0");
			...
			builder.put(grammarAccess.getDomainInformationViewAccess().getNotesAssignment_6(), "rule__DomainInformationView__NotesAssignment_6");
			builder.put(grammarAccess.getDomainInformationViewAccess().getTypesAssignment_8_0(), "rule__DomainInformationView__TypesAssignment_8_0");
			builder.put(grammarAccess.getDomainInformationViewAccess().getAggregatesAssignment_8_1(), "rule__DomainInformationView__AggregatesAssignment_8_1");
			...
			builder.put(grammarAccess.getDivMorphComplexTypeRuleAccess().getSourceAssignment_0(), "rule__DivMorphComplexTypeRule__SourceAssignment_0");
			builder.put(grammarAccess.getDivMorphComplexTypeRuleAccess().getReadOnlyViewAssignment_2(), "rule__DivMorphComplexTypeRule__ReadOnlyViewAssignment_2");
			...
			builder.put(grammarAccess.getDivAggregateTranspositionAccess().getFeaturesAssignment_5_1_0(), "rule__DivAggregateTransposition__FeaturesAssignment_5_1_0");
			builder.put(grammarAccess.getDivAggregateTranspositionAccess().getFeaturesAssignment_5_1_1_2(), "rule__DivAggregateTransposition__FeaturesAssignment_5_1_1_2");
			...
			builder.put(grammarAccess.getDivPrimitiveTranspositionAccess().getNotesAssignment_3(), "rule__DivPrimitiveTransposition__NotesAssignment_3");
			builder.put(grammarAccess.getDivPrimitiveTranspositionAccess().getConstraintsAssignment_4_1_1(), "rule__DivPrimitiveTransposition__ConstraintsAssignment_4_1_1");
			...
			builder.put(grammarAccess.getDivEnumerationTranspositionAccess().getNotesAssignment_3(), "rule__DivEnumerationTransposition__NotesAssignment_3");
			builder.put(grammarAccess.getDivEnumerationTranspositionAccess().getLiteralsAssignment_4_1_0(), "rule__DivEnumerationTransposition__LiteralsAssignment_4_1_0");
			builder.put(grammarAccess.getDivEnumerationTranspositionAccess().getLiteralsAssignment_4_1_1_1(), "rule__DivEnumerationTransposition__LiteralsAssignment_4_1_1_1");
			builder.put(grammarAccess.getDivEnumerationTranspositionAccess().getConstraintsAssignment_4_2_1(), "rule__DivEnumerationTransposition__ConstraintsAssignment_4_2_1");
			...
			builder.put(grammarAccess.getDivLiteralTranspositionAccess().getNotesAssignment_3(), "rule__DivLiteralTransposition__NotesAssignment_3");
			...
			builder.put(grammarAccess.getDivEntityTypeTranspositionAccess().getNotesAssignment_3(), "rule__DivEntityTypeTransposition__NotesAssignment_3");
			...
			builder.put(grammarAccess.getDivDetailTypeTranspositionAccess().getNotesAssignment_3(), "rule__DivDetailTypeTransposition__NotesAssignment_3");
			...
			builder.put(grammarAccess.getDivAssociationTranspositionAccess().getNotesAssignment_3(), "rule__DivAssociationTransposition__NotesAssignment_3");
			...
			builder.put(grammarAccess.getDivAttributeTranspositionAccess().getNotesAssignment_3(), "rule__DivAttributeTransposition__NotesAssignment_3");
			...
			builder.put(grammarAccess.getDivQueryTranspositionAccess().getNotesAssignment_3(), "rule__DivQueryTransposition__NotesAssignment_3");
