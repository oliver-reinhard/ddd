...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TSynthetic Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.dm.base.synthetic.impl.TSyntheticTypeImpl#getRecipe <em>Recipe</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TSyntheticTypeImpl extends DTypeImpl implements TSyntheticType
{
	/**
	...
	{
		return SyntheticPackage.Literals.TSYNTHETIC_TYPE;
	}
		...
		if (recipe != null && recipe.eIsProxy())
		{
			...
			if (recipe != oldRecipe)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SyntheticPackage.TSYNTHETIC_TYPE__RECIPE, oldRecipe, recipe));
			}
		}
		return recipe;
	}
	...
	public void setRecipe(ITransposition newRecipe)
	{
		...
		recipe = newRecipe;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntheticPackage.TSYNTHETIC_TYPE__RECIPE, oldRecipe, recipe));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case SyntheticPackage.TSYNTHETIC_TYPE__RECIPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == ISyntheticElement.class)
		{
			...
			{
				case SyntheticPackage.TSYNTHETIC_TYPE__RECIPE: return TransposePackage.ISYNTHETIC_ELEMENT__RECIPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == ISyntheticElement.class)
		{
			...
			{
				case TransposePackage.ISYNTHETIC_ELEMENT__RECIPE: return SyntheticPackage.TSYNTHETIC_TYPE__RECIPE;
				default: return -1;
			}
		}
