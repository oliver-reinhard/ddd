...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TSynthetic Query</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.dm.base.synthetic.impl.TSyntheticQueryImpl#getRecipe <em>Recipe</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TSyntheticQueryImpl extends DQueryImplCustom implements TSyntheticQuery
{
	/**
	...
	{
		return SyntheticPackage.Literals.TSYNTHETIC_QUERY;
	}
		...
		if (recipe != null && recipe.eIsProxy())
		{
			...
			if (recipe != oldRecipe)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SyntheticPackage.TSYNTHETIC_QUERY__RECIPE, oldRecipe, recipe));
			}
		}
		return recipe;
	}
	...
	public void setRecipe(ITransposition newRecipe)
	{
		...
		recipe = newRecipe;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntheticPackage.TSYNTHETIC_QUERY__RECIPE, oldRecipe, recipe));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case SyntheticPackage.TSYNTHETIC_QUERY__RECIPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == ISyntheticElement.class)
		{
			...
			{
				case SyntheticPackage.TSYNTHETIC_QUERY__RECIPE: return TransposePackage.ISYNTHETIC_ELEMENT__RECIPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == ISyntheticElement.class)
		{
			...
			{
				case TransposePackage.ISYNTHETIC_ELEMENT__RECIPE: return SyntheticPackage.TSYNTHETIC_QUERY__RECIPE;
				default: return -1;
			}
		}
		if (baseClass == TSyntheticFeature.class)
