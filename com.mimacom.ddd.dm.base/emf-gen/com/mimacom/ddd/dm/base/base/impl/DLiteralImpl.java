 ...
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.dm.base.base.impl.DLiteralImpl#getTransposedBy <em>Transposed By</em>}</li>
 *   <li>{@link com.mimacom.ddd.dm.base.base.impl.DLiteralImpl#isSynthetic <em>Synthetic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DLiteralImpl extends DNavigableMemberImplCustom implements DLiteral
{
		...
		if (transposedBy != null && transposedBy.eIsProxy())
		{
			...
			if (transposedBy != oldTransposedBy)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasePackage.DLITERAL__TRANSPOSED_BY, oldTransposedBy, transposedBy));
			}
		}
		return transposedBy;
	}
	...
	public void setTransposedBy(ITransposition newTransposedBy)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.DLITERAL__TRANSPOSED_BY, oldTransposedBy, transposedBy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case BasePackage.DLITERAL__TRANSPOSED_BY:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == ITransposableElement.class)
		{
			...
			{
				case BasePackage.DLITERAL__TRANSPOSED_BY: return BasePackage.ITRANSPOSABLE_ELEMENT__TRANSPOSED_BY;
				case BasePackage.DLITERAL__SYNTHETIC: return BasePackage.ITRANSPOSABLE_ELEMENT__SYNTHETIC;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == ITransposableElement.class)
		{
			...
			{
				case BasePackage.ITRANSPOSABLE_ELEMENT__TRANSPOSED_BY: return BasePackage.DLITERAL__TRANSPOSED_BY;
				case BasePackage.ITRANSPOSABLE_ELEMENT__SYNTHETIC: return BasePackage.DLITERAL__SYNTHETIC;
				default: return -1;
			}
		}
