 ...
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.dm.base.base.impl.DQueryParameterImpl#getTransposedBy <em>Transposed By</em>}</li>
 *   <li>{@link com.mimacom.ddd.dm.base.base.impl.DQueryParameterImpl#isSynthetic <em>Synthetic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DQueryParameterImpl extends DNavigableMemberImplCustom implements DQueryParameter
{
		...
		if (transposedBy != null && transposedBy.eIsProxy())
		{
			...
			if (transposedBy != oldTransposedBy)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasePackage.DQUERY_PARAMETER__TRANSPOSED_BY, oldTransposedBy, transposedBy));
			}
		}
		return transposedBy;
	}
	...
	public void setTransposedBy(ITransposition newTransposedBy)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.DQUERY_PARAMETER__TRANSPOSED_BY, oldTransposedBy, transposedBy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case BasePackage.DQUERY_PARAMETER__TRANSPOSED_BY:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == ITransposableElement.class)
		{
			...
			{
				case BasePackage.DQUERY_PARAMETER__TRANSPOSED_BY: return BasePackage.ITRANSPOSABLE_ELEMENT__TRANSPOSED_BY;
				case BasePackage.DQUERY_PARAMETER__SYNTHETIC: return BasePackage.ITRANSPOSABLE_ELEMENT__SYNTHETIC;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == ITransposableElement.class)
		{
			...
			{
				case BasePackage.ITRANSPOSABLE_ELEMENT__TRANSPOSED_BY: return BasePackage.DQUERY_PARAMETER__TRANSPOSED_BY;
				case BasePackage.ITRANSPOSABLE_ELEMENT__SYNTHETIC: return BasePackage.DQUERY_PARAMETER__SYNTHETIC;
				default: return -1;
			}
		}
