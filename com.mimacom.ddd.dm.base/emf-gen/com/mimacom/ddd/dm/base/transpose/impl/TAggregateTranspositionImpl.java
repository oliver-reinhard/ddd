 ...
 * </p>
 * <ul>
 *   <li>{@link com.mimacom.ddd.dm.base.transpose.impl.TAggregateTranspositionImpl#getRule <em>Rule</em>}</li>
...
public class TAggregateTranspositionImpl extends DAggregateImplCustom implements TAggregateTransposition
{
	...
	public NotificationChain basicSetRule(TTranspositionRule newRule, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TransposePackage.TAGGREGATE_TRANSPOSITION__RULE, oldRule, newRule);
	...
	public void setRule(TTranspositionRule newRule)
	{
		if (newRule != rule)
		{
			...
			if (rule != null)
				msgs = ((InternalEObject)rule).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TransposePackage.TAGGREGATE_TRANSPOSITION__RULE, null, msgs);
			if (newRule != null)
				msgs = ((InternalEObject)newRule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TransposePackage.TAGGREGATE_TRANSPOSITION__RULE, null, msgs);
			msgs = basicSetRule(newRule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransposePackage.TAGGREGATE_TRANSPOSITION__RULE, newRule, newRule));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case TransposePackage.TAGGREGATE_TRANSPOSITION__RULE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == ITransposition.class)
		{
			...
			{
				case TransposePackage.TAGGREGATE_TRANSPOSITION__RULE: return TransposePackage.ITRANSPOSITION__RULE;
				case TransposePackage.TAGGREGATE_TRANSPOSITION__IMPLIED_TRANSPOSITIONS: return TransposePackage.ITRANSPOSITION__IMPLIED_TRANSPOSITIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == ITransposition.class)
		{
			...
			{
				case TransposePackage.ITRANSPOSITION__RULE: return TransposePackage.TAGGREGATE_TRANSPOSITION__RULE;
				case TransposePackage.ITRANSPOSITION__IMPLIED_TRANSPOSITIONS: return TransposePackage.TAGGREGATE_TRANSPOSITION__IMPLIED_TRANSPOSITIONS;
				default: return -1;
			}
		}
