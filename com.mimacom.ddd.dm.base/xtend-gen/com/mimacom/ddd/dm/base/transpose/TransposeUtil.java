...
public class TransposeUtil {
  ...
  public static boolean isDeductionProxyURI(final URI uri) {
    ...
    return ((fragment != null) && fragment.startsWith(TransposeUtil.DEDUCTION_PROXY_URI_FRAGMENT_PREFIX));
  }
  
  public static String getDeductionProxyUriFragment(final QualifiedName qualifiedName) {
    QualifiedName _deductionSourceQNForIndex = TransposeUtil.getDeductionSourceQNForIndex(qualifiedName.toString());
    return (TransposeUtil.DEDUCTION_PROXY_URI_FRAGMENT_PREFIX + _deductionSourceQNForIndex);
  }
  ...
  public static QualifiedName getDeductionSourceQN(final URI proxyUri) {
    ...
    if (((fragment == null) || (!fragment.startsWith(TransposeUtil.DEDUCTION_PROXY_URI_FRAGMENT_PREFIX)))) {
      return null;
    }
    final String sourceQNStr = fragment.substring(TransposeUtil.DEDUCTION_PROXY_URI_FRAGMENT_PREFIX.length());
  ...
  public static QualifiedName getDeductionTargetQN(final IEObjectDescription description) {
    return QualifiedName.create(description.getUserData(TransposeUtil.KEY_DEDUCTION_TARGET_TYPE).split("\\."));
  }
  ...
  public static QualifiedName getDeductionSourceQNForIndex(final QualifiedName qualifiedName) {
    return TransposeUtil.getDeductionSourceQNForIndex(qualifiedName.toString());
  }
  ...
  public static Map<String, String> createEObjectDescriptionUserData(final QualifiedName targetQN) {
    ...
    userData.put(TransposeUtil.KEY_DEDUCTION_TARGET_TYPE, targetQN.toString());
    return userData;
  }
}
