 ...
 */
package com.mimacom.ddd.dm.dms.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import com.mimacom.ddd.dm.dms.ide.contentassist.antlr.internal.InternalDmsParser;
import com.mimacom.ddd.dm.dms.services.DmsGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class DmsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(DmsGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DmsGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getDModelAccess().getAlternatives_1_2(), "rule__DModel__Alternatives_1_2");
			builder.put(grammarAccess.getGlobalValueTypesAccess().getAlternatives(), "rule__GlobalValueTypes__Alternatives");
			builder.put(grammarAccess.getDDomainAccess().getAlternatives_4(), "rule__DDomain__Alternatives_4");
			...
			builder.put(grammarAccess.getDModelAccess().getGroup(), "rule__DModel__Group__0");
			builder.put(grammarAccess.getDModelAccess().getGroup_1(), "rule__DModel__Group_1__0");
			builder.put(grammarAccess.getDFunctionAccess().getGroup(), "rule__DFunction__Group__0");
			builder.put(grammarAccess.getDFunctionAccess().getGroup_4(), "rule__DFunction__Group_4__0");
			...
			builder.put(grammarAccess.getDRootTypeAccess().getGroup(), "rule__DRootType__Group__0");
			...
			builder.put(grammarAccess.getDQueryAccess().getGroup_7(), "rule__DQuery__Group_7__0");
			...
			builder.put(grammarAccess.getDServiceAccess().getGroup_2(), "rule__DService__Group_2__0");
			builder.put(grammarAccess.getDServiceAccess().getGroup_2_2(), "rule__DService__Group_2_2__0");
			builder.put(grammarAccess.getDServiceAccess().getGroup_4(), "rule__DService__Group_4__0");
			builder.put(grammarAccess.getDServiceAccess().getGroup_5(), "rule__DService__Group_5__0");
			builder.put(grammarAccess.getDServiceAccess().getGroup_6(), "rule__DService__Group_6__0");
			builder.put(grammarAccess.getDServiceAccess().getGroup_7(), "rule__DService__Group_7__0");
			builder.put(grammarAccess.getDServiceAccess().getGroup_7_2(), "rule__DService__Group_7_2__0");
			...
			builder.put(grammarAccess.getDModelAccess().getGlobalTypesAssignment_1_2_0(), "rule__DModel__GlobalTypesAssignment_1_2_0");
			builder.put(grammarAccess.getDModelAccess().getGlobalFunctionsAssignment_1_2_1(), "rule__DModel__GlobalFunctionsAssignment_1_2_1");
			builder.put(grammarAccess.getDModelAccess().getDomainAssignment_2(), "rule__DModel__DomainAssignment_2");
			builder.put(grammarAccess.getDFunctionAccess().getNameAssignment_1(), "rule__DFunction__NameAssignment_1");
			builder.put(grammarAccess.getDFunctionAccess().getParameterNamesAssignment_3(), "rule__DFunction__ParameterNamesAssignment_3");
			builder.put(grammarAccess.getDFunctionAccess().getParameterNamesAssignment_4_1(), "rule__DFunction__ParameterNamesAssignment_4_1");
			builder.put(grammarAccess.getDFunctionAccess().getTypeAssignment_7(), "rule__DFunction__TypeAssignment_7");
			builder.put(grammarAccess.getDFunctionAccess().getMultiplicityAssignment_8(), "rule__DFunction__MultiplicityAssignment_8");
			builder.put(grammarAccess.getDDomainAccess().getNameAssignment_1(), "rule__DDomain__NameAssignment_1");
			builder.put(grammarAccess.getDDomainAccess().getDescriptionAssignment_2(), "rule__DDomain__DescriptionAssignment_2");
			builder.put(grammarAccess.getDDomainAccess().getImportsAssignment_3(), "rule__DDomain__ImportsAssignment_3");
			builder.put(grammarAccess.getDDomainAccess().getTypesAssignment_4_0(), "rule__DDomain__TypesAssignment_4_0");
			builder.put(grammarAccess.getDDomainAccess().getAggregatesAssignment_4_1(), "rule__DDomain__AggregatesAssignment_4_1");
			builder.put(grammarAccess.getDDomainAccess().getApplicationsAssignment_4_2(), "rule__DDomain__ApplicationsAssignment_4_2");
			builder.put(grammarAccess.getDDomainAccess().getEventsAssignment_4_3(), "rule__DDomain__EventsAssignment_4_3");
			builder.put(grammarAccess.getDDomainAccess().getActorsAssignment_4_4(), "rule__DDomain__ActorsAssignment_4_4");
			...
			builder.put(grammarAccess.getDEnumerationAccess().getLiteralsAssignment_4_1_1(), "rule__DEnumeration__LiteralsAssignment_4_1_1");
			builder.put(grammarAccess.getDEnumerationAccess().getConstraintsAssignment_5(), "rule__DEnumeration__ConstraintsAssignment_5");
			builder.put(grammarAccess.getDLiteralAccess().getNameAssignment_0(), "rule__DLiteral__NameAssignment_0");
			builder.put(grammarAccess.getDLiteralAccess().getDescriptionAssignment_1(), "rule__DLiteral__DescriptionAssignment_1");
			builder.put(grammarAccess.getDRootTypeAccess().getAbstractAssignment_0(), "rule__DRootType__AbstractAssignment_0");
			...
			builder.put(grammarAccess.getDComplexTypeAccess().getSuperTypeAssignment_1_1(), "rule__DComplexType__SuperTypeAssignment_1_1");
			builder.put(grammarAccess.getDComplexTypeAccess().getDescriptionAssignment_2(), "rule__DComplexType__DescriptionAssignment_2");
			builder.put(grammarAccess.getDComplexTypeAccess().getFeaturesAssignment_4_0(), "rule__DComplexType__FeaturesAssignment_4_0");
			builder.put(grammarAccess.getDComplexTypeAccess().getConstraintsAssignment_4_1(), "rule__DComplexType__ConstraintsAssignment_4_1");
			...
			builder.put(grammarAccess.getDQueryAccess().getTypeAssignment_5(), "rule__DQuery__TypeAssignment_5");
			builder.put(grammarAccess.getDQueryAccess().getMultiplicityAssignment_6(), "rule__DQuery__MultiplicityAssignment_6");
			builder.put(grammarAccess.getDQueryAccess().getReturnsAssignment_7_1(), "rule__DQuery__ReturnsAssignment_7_1");
			builder.put(grammarAccess.getDQueryAccess().getDescriptionAssignment_8(), "rule__DQuery__DescriptionAssignment_8");
			...
			builder.put(grammarAccess.getDDomainEventAccess().getTriggerAssignment_4(), "rule__DDomainEvent__TriggerAssignment_4");
			builder.put(grammarAccess.getDDomainEventAccess().getDescriptionAssignment_5(), "rule__DDomainEvent__DescriptionAssignment_5");
			builder.put(grammarAccess.getDDomainEventAccess().getContextAssignment_7(), "rule__DDomainEvent__ContextAssignment_7");
			builder.put(grammarAccess.getDDomainEventAccess().getNotificationsAssignment_8(), "rule__DDomainEvent__NotificationsAssignment_8");
			builder.put(grammarAccess.getDDomainEventAccess().getBeforeAssignment_9_1(), "rule__DDomainEvent__BeforeAssignment_9_1");
			builder.put(grammarAccess.getDDomainEventAccess().getAfterAssignment_10_1(), "rule__DDomainEvent__AfterAssignment_10_1");
			builder.put(grammarAccess.getDConditionAccess().getNameAssignment_1(), "rule__DCondition__NameAssignment_1");
			...
			builder.put(grammarAccess.getDNotificationAccess().getNameAssignment_1(), "rule__DNotification__NameAssignment_1");
			...
			builder.put(grammarAccess.getDContextAccess().getNameAssignment_1(), "rule__DContext__NameAssignment_1");
			...
			builder.put(grammarAccess.getDHumanAccess().getDescriptionAssignment_3(), "rule__DHuman__DescriptionAssignment_3");
			builder.put(grammarAccess.getDTimeAccess().getNameAssignment_2(), "rule__DTime__NameAssignment_2");
			builder.put(grammarAccess.getDTimeAccess().getDescriptionAssignment_3(), "rule__DTime__DescriptionAssignment_3");
			...
			builder.put(grammarAccess.getDServiceAccess().getNameAssignment_1(), "rule__DService__NameAssignment_1");
			builder.put(grammarAccess.getDServiceAccess().getParametersAssignment_2_1(), "rule__DService__ParametersAssignment_2_1");
			builder.put(grammarAccess.getDServiceAccess().getParametersAssignment_2_2_1(), "rule__DService__ParametersAssignment_2_2_1");
			builder.put(grammarAccess.getDServiceAccess().getDescriptionAssignment_3(), "rule__DService__DescriptionAssignment_3");
			builder.put(grammarAccess.getDServiceAccess().getKindAssignment_4_1(), "rule__DService__KindAssignment_4_1");
			builder.put(grammarAccess.getDServiceAccess().getPreconditionAssignment_5_1(), "rule__DService__PreconditionAssignment_5_1");
			builder.put(grammarAccess.getDServiceAccess().getPostconditionAssignment_6_1(), "rule__DService__PostconditionAssignment_6_1");
			builder.put(grammarAccess.getDServiceAccess().getRaisesAssignment_7_1(), "rule__DService__RaisesAssignment_7_1");
			builder.put(grammarAccess.getDServiceAccess().getRaisesAssignment_7_2_1(), "rule__DService__RaisesAssignment_7_2_1");
	...
	@Override
	protected InternalDmsParser createParser() {
		InternalDmsParser result = new InternalDmsParser(null);
